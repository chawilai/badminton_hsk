            ...
            <div class="flex flex-column align-items-center justify-content-center w-full md:w-4 h-full text-center py-6 px-4">
                ...
                <div class="flex flex-column">
                    <IconField iconPosition="left" class="w-full mb-4">
                        ...
                        <Password id="password" placeholder="Password" v-model="value1" class="w-full" :inputStyle="{ paddingLeft: '2.5rem' }" inputClass="w-full md:w-25rem text-color-secondary surface-50 border-200" toggleMask></Password>
                    </IconField>
                    <IconField iconPosition="left" class="w-full mb-4">
                        <InputIcon class="pi pi-lock z-2" />
                        <Password
                            ...
                            inputClass="w-full md:w-25rem text-color-secondary surface-50 border-200"
                            toggleMask
                            :feedback="false"
                        ></Password>
                    </IconField>
