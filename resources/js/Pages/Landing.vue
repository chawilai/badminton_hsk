...
<template>
    <div :class="(menu?.classList.contains('hidden') && menu?.classList.contains('absolute') ? 'h-auto ' : 'overflow-hidden h-screen  md:h-auto ') + 'landing-wrapper'">
        <div :class="(menu?.classList.contains('hidden') && menu?.classList.contains('absolute') ? 'hidden ' : 'block md:hidden ') + ' absolute z-4 top-0 right-0 w-full h-screen'" style="background-color: var(--maskbg)"></div>
        <div class="flex align-items-center justify-content-between relative lg:static py-6 mx-0 px-4 lg:py-6">
            ...
            <a
                v-ripple
                class="p-ripple cursor-pointer block md:hidden text-700 text-primary"
                v-styleclass="{ selector: '@next', enterClass: 'hidden', enterActiveClass: 'px-fadein', leaveToClass: 'hidden', leaveActiveClass: 'px-fadeout', hideOnOutsideClick: 'true' }"
            >
                <i class="pi pi-bars text-4xl"></i>
            </a>

            <ul ref="menu" style="top: 0px; right: 0%" class="list-none flex-grow-1 justify-content-end hidden md:flex absolute md:relative h-screen md:h-auto surface-card md:surface-ground m-0 z-5 w-full sm:w-6 md:w-full py-6 md:py-0">
                <a
                    v-ripple
                    class="p-ripple cursor-pointer block md:hidden text-700 text-primary absolute"
                ...
                <li class="mt-5 md:mt-0">
                    <a
                        ...
                        class="p-ripple flex m-0 md:ml-5 md:px-0 px-3 py-3 text-900 font-medium line-height-3 hover:text-primary cursor-pointer"
                    >
                        <span>Home</span>
                    </a>
                </li>
                ...
                <li class="flex align-items-center">
                    <Button type="button" v-styleclass="{ selector: '@grandparent', enterClass: 'hidden', enterActiveClass: 'px-fadein', leaveToClass: 'hidden' }" label="Buy Now" class="m-0 mt-3 md:mt-0 ml-3 md:ml-5"></Button>
                </li>
            </ul>
        </div>
        <div ref="home" id="home" class="landing-banner px-4 md:px-8 py-8 lg:flex flex-wrap">
            <div class="banner-left w-full lg:w-8">
                <span class="block font-normal mb-6 text-6xl sm:text-7xl xl:text-8xl text-900 w-12">Start Your Business With The All-In-One <b class="text-primary font-medium">FREYA</b> Dashboard Template!</span>
                <h4 class="font-normal text-900 m-0 mb-6 line-height-3 w-10" style="letter-spacing: 0.6px">
                ...
                <Button label="Learn More" icon="pi pi-arrow-right" size="large" class="mb-6"></Button>

                <div class="logo-section relative w-full md:w-8 mt-6">
                    <div class="fade-left h-2rem w-6rem block absolute top-0 left-0" style="background: linear-gradient(to right, var(--surface-ground), transparent); z-index: 2"></div>
                    <div class="marquee-wrapper relative overflow-hidden flex gap-6">
                        <div class="marquee flex gap-6" style="animation-duration: 50s">
                            <img src="@/../assets/demo/images/landing/logocloud/alfred-500.svg" class="h-2rem" alt="" />
                            <img src="@/../assets/demo/images/landing/logocloud/bastion-500.svg" class="h-2rem" alt="" />
                            <img src="@/../assets/demo/images/landing/logocloud/charot-500.svg" class="h-2rem" alt="" />
                            <img src="@/../assets/demo/images/landing/logocloud/franki-500.svg" class="h-2rem" alt="" />
                            <img src="@/../assets/demo/images/landing/logocloud/hodly-500.svg" class="h-2rem" alt="" />
                            <img src="@/../assets/demo/images/landing/logocloud/hyper-500.svg" class="h-2rem" alt="" />
                            <img src="@/../assets/demo/images/landing/logocloud/shodan-500.svg" class="h-2rem" alt="" />
                        </div>
                        <div class="marquee flex gap-6" style="animation-duration: 50s">
                            <img src="@/../assets/demo/images/landing/logocloud/alfred-500.svg" class="h-2rem" alt="" />
                            <img src="@/../assets/demo/images/landing/logocloud/bastion-500.svg" class="h-2rem" alt="" />
                    ...
                    <div class="fade-right h-2rem w-6rem block absolute top-0 right-0" style="background: linear-gradient(to left, var(--surface-ground), transparent); z-index: 2"></div>
                </div>
            </div>
            <div class="banner-right w-4 hidden lg:block">
                <div id="ex1" class="cards w-full flex flex-column align-items-end mt-8 pl-3">
        ...
        <div ref="features" id="features" class="landing-section px-4 md:px-8 py-8 mb-8">
            <div class="section-top lg:flex w-full gap-6 align-items-center mb-6">
                <span class="block font-normal text-6xl sm:text-7xl xl:text-8xl text-900 lg:w-8">Wide range of features and the stylish use of <b class="text-primary font-medium">PrimeVue</b> components</span>
                <div class="lg:w-4 lg:mt-0 mt-5">
                    <h3 class="font-normal text-900 m-0 mb-6 w-full" style="letter-spacing: 0.6px">
                    ...
                    <Button label="Learn More" icon="pi pi-arrow-right" size="large"></Button>
                </div>
            </div>
            <div class="feature-cards grid mt-8 pt-4">
                <div class="col-12 sm:col-6 lg:col-4">
                    <div class="card p-0 h-full">
                        <svg animateEnter="fadein" viewBox="0 0 443 257" class="w-full border-round-3xl mb-4" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="p-0 m-0 text-xl block line-height-3 px-5 pb-5" style="letter-spacing: 0.4px">A user-friendly interface that is intuitive and simple to navigate, enabling users to quickly find the information they need.</span>
                    </div>
                </div>
                <div class="col-12 sm:col-6 lg:col-4">
                    <div class="card p-0 h-full">
                        ...
                        <span class="p-0 m-0 text-xl block line-height-3 px-5 pb-5" style="letter-spacing: 0.4px">A website that loads quickly, providing users with a seamless browsing experience and improving SEO rankings.</span>
                    </div>
                </div>
                <div class="col-12 sm:col-6 lg:col-4">
                    <div class="card p-0 h-full">
                        <svg animateEnter="fadein" class="w-full border-round-3xl mb-4" viewBox="0 0 443 257" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <mask id="mask0_436_2322" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="443" height="257">
                            ...
                            <g mask="url(#mask0_436_2322)">
                                <g opacity="0.75">
                                    ...
                                    <g clip-path="url(#clip0_436_2322)">
                                        <path
                                            fill-rule="evenodd"
                                            clip-rule="evenodd"
                                ...
                                <rect x="37.0806" y="138.682" width="305.791" height="6.97623" rx="2.90676" stroke="var(--primary-300)" stroke-width="1.1627" />

                                <rect x="37.0806" y="156.123" width="266.259" height="6.97623" rx="2.90676" fill="var(--primary-500)" opacity="0.5" />
                                <rect x="37.0806" y="156.123" width="266.259" height="6.97623" rx="2.90676" stroke="var(--primary-300)" stroke-width="1.1627" />
                        ...
                        <span class="p-0 m-0 text-xl block line-height-3 px-5 pb-5" style="letter-spacing: 0.4px">
                ...
                <div class="col-12 sm:col-6 lg:col-4">
                    <div class="card p-0 h-full">
                        <svg animateEnter="fadein" class="w-full border-round-3xl mb-4" viewBox="0 0 443 257" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <mask id="mask0_436_2345" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="443" height="257">
                            ...
                            <g mask="url(#mask0_436_2345)">
                                ...
                                <rect x="28.9248" y="26.5128" width="382.892" height="225.401" rx="7.94682" stroke="var(--primary-500)" stroke-width="1.44488" />
                                ...
                                <rect x="139.458" y="49.6307" width="161.826" height="179.165" rx="7.94682" stroke="var(--primary-500)" stroke-width="1.44488" />
                                ...
                                <rect x="190.751" y="83.5854" width="59.24" height="111.256" rx="7.94682" stroke="var(--primary-500)" stroke-width="1.44488" />
                            </g>
                            <defs>
                        ...
                        <span class="p-0 m-0 text-xl block line-height-3 px-5 pb-5" style="letter-spacing: 0.4px">A design that adapts to different screen sizes and devices, ensuring that content is accessible and easy to read on all devices.</span>
                    </div>
                </div>
                <div class="col-12 sm:col-6 lg:col-4">
                    <div class="card p-0 h-full">
                        <svg animateEnter="fadein" class="w-full border-round-3xl mb-4" viewBox="0 0 444 257" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <mask id="mask0_436_2360" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="444" height="257">
                            ...
                            <g mask="url(#mask0_436_2360)">
                                ...
                                <g clip-path="url(#clip0_436_2360)">
                                    <path
                                ...
                                <rect y="0.561843" width="65.178" height="65.1791" rx="32.589" transform="matrix(0.866044 0.499967 -0.866044 0.499967 336.923 66.7666)" stroke="var(--primary-300)" stroke-width="1.12376" />
                                ...
                                <g clip-path="url(#clip1_436_2360)">
                                    <path
                                ...
                                <rect y="0.561843" width="65.178" height="65.1791" rx="32.589" transform="matrix(0.866044 0.499967 -0.866044 0.499967 222.081 127.852)" stroke="var(--primary-300)" stroke-width="1.12376" />
                                ...
                                <g clip-path="url(#clip2_436_2360)">
                                    <path
                                ...
                                <rect y="0.561843" width="65.178" height="65.1791" rx="32.589" transform="matrix(0.866044 0.499967 -0.866044 0.499967 222.109 10.8927)" stroke="var(--primary-300)" stroke-width="1.12376" />
                                ...
                                <g clip-path="url(#clip3_436_2360)">
                                    <path
                                ...
                                <rect y="0.561843" width="65.178" height="65.1791" rx="32.589" transform="matrix(0.866044 0.499967 -0.866044 0.499967 107.267 71.9784)" stroke="var(--primary-300)" stroke-width="1.12376" />
                            </g>
                            <defs>
                ...
                <div class="col-12 sm:col-6 lg:col-4">
                    <div class="card p-0 h-full">
                        <svg animateEnter="fadein" class="w-full border-round-3xl mb-4" viewBox="0 0 443 257" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <mask id="mask0_436_2387" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="443" height="257">
                                <rect width="442.667" height="257" transform="translate(0.333313)" fill="url(#paint0_linear_436_2387)" />
                            </mask>
                            <g mask="url(#mask0_436_2387)">
                                <mask id="mask1_436_2387" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="124" y="34" width="219" height="189">
                                ...
                                <g mask="url(#mask1_436_2387)">
                                    <path
                                        ...
                                        stroke-width="0.917219"
                                    />
                                </g>
                                <g opacity="0.5">
                                    <mask id="mask2_436_2387" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="209" y="57" width="166" height="143">
                                    ...
                                    <g mask="url(#mask2_436_2387)">
                                        <path
                                            ...
                                            fill="var(--primary-500)"
                                            stroke="var(--primary-500)"
                                            stroke-width="0.694733"
                                        />
                                    </g>
                                </g>
                                <g opacity="0.25">
                                    <mask id="mask3_436_2387" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="288" y="81" width="109" height="95">
                                    ...
                                    <g mask="url(#mask3_436_2387)">
                                        <path
                                            ...
                                            fill="var(--primary-500)"
                                            stroke="var(--primary-500)"
                                            stroke-width="0.455941"
                                        />
                                    </g>
                                </g>
                                <mask id="mask4_436_2387" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="101" y="34" width="218" height="189">
                                ...
                                <g opacity="0.5">
                                    <mask id="mask5_436_2387" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="69" y="57" width="165" height="143">
                                ...
                                <g opacity="0.25">
                                    <mask id="mask6_436_2387" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="47" y="81" width="109" height="95">
                                ...
                                <path
                                    ...
                                    fill="var(--primary-700)"
                                />
                                <rect x="139.84" y="57.5968" width="163.653" height="141.806" rx="70.9032" stroke="var(--primary-300)" stroke-width="0.915632" />
                            </g>
                            <defs>
                                ...
                                <radialGradient id="paint1_radial_436_2387" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(217.271 94.2142) rotate(180) scale(209.792 143.525)">
                                    <stop offset="0.887131" stop-color="white" stop-opacity="0" />
                                    <stop offset="1" stop-color="var(--primary-700)" />
                                </radialGradient>
                                <radialGradient id="paint2_radial_436_2387" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(164.569 71.3611) rotate(180) scale(158.904 151.525)">
                                    <stop offset="0.776042" stop-color="var(--primary-700)" stop-opacity="0" />
                                    <stop offset="1" stop-color="var(--primary-700)" />
                                </radialGradient>
        ...
        <div ref="customizations" id="customizations" class="landing-section px-4 md:px-8 py-8 mt-8">
            <div class="section-top flex w-full flex-column gap-6 align-items-center justify-content-center mb-6">
                <span class="block font-normal text-6xl sm:text-7xl xl:text-8xl text-900">Make it Your Own </span>
                <h4 class="lg:w-8 font-normal text-900 m-0 mb-6 text-center line-height-3" style="letter-spacing: 0.6px">
            ...
            <div class="video relative" style="max-width: 62rem; margin: 0 auto">
                <img src="@/../assets/demo/images/landing/image-3.png" class="w-full border-round-3xl mb-4" alt="" />
                <Button icon="pi pi-play text-8xl ml-3" @click="showModalDialog()" class="absolute top-50 right-50 text-3xl" rounded style="margin-right: -5rem; margin-top: -5rem; height: 10rem; width: 10rem"></Button>
            </div>
        ...
        <div ref="apps" id="apps" class="landing-section px-4 md:px-8 py-8 mt-8">
            <div class="section-top flex w-full gap-6 align-items-center justify-content-start mb-6">
                <span class="block font-normal text-6xl sm:text-7xl xl:text-8xl text-900">Ready to Use Applications </span>
            </div>
            <div class="content lg:flex justify-content-between gap-6">
                <div class="left lg:w-6">
                    <h4 class="w-11 font-normal text-900 m-0 mb-6 line-height-3" style="letter-spacing: 0.6px">
                    ...
                    <ul class="list-none p-0 m-0">
                        <li class="mb-4 flex align-items-center">
                            <a @mouseover="changeImageOnHover(0)" :style="activeLink == 0 ? 'color:var(--primary-color) !important' : ''" class="text-4xl font-medium text-900 hover:text-primary transition-duration-200 cursor-pointer">Chat </a>
                            <i v-if="activeLink == 0" class="pi pi-arrow-right text-4xl text-primary ml-3"></i>
                        </li>
                        <li class="mb-4 flex align-items-center">
                            <a @mouseover="changeImageOnHover(1)" :style="activeLink == 1 ? 'color:var(--primary-color) !important' : ''" class="text-4xl font-medium text-900 hover:text-primary transition-duration-200 cursor-pointer">Mail</a>
                            <i v-if="activeLink == 1" class="pi pi-arrow-right text-4xl text-primary ml-3"></i>
                        </li>

                        <li class="mb-4 flex align-items-center">
                            <a @mouseover="changeImageOnHover(2)" :style="activeLink == 3 ? 'color:var(--primary-color) !important' : ''" class="text-4xl font-medium text-900 hover:text-primary transition-duration-200 cursor-pointer">Task List</a>
                            <i v-if="activeLink == 3" class="pi pi-arrow-right text-4xl text-primary ml-3"></i>
                        </li>
                        <li class="mb-4 flex align-items-center">
                            <a @mouseover="changeImageOnHover(3)" :style="activeLink == 4 ? 'color:var(--primary-color) !important' : ''" class="text-4xl font-medium text-900 hover:text-primary transition-duration-200 cursor-pointer">Blog</a>
                            <i v-if="activeLink == 4" class="pi pi-arrow-right text-4xl text-primary ml-3"></i>
                        </li>
                    </ul>
                </div>
                <div class="right lg:w-6 mt-5 lg:mt-0">
        ...
        <div ref="pricing" id="pricing" class="landing-section px-4 md:px-8 py-8 mt-8">
            <div class="surface-ground px-4 py-8 md:px-6 lg:px-8 bg-no-repeat bg-cover" style="border-radius: 24px; background: linear-gradient(to left bottom, var(--primary-lighter-color), var(--surface-0))">
                <div class="flex flex-wrap align-items-center">
                    <div class="w-full lg:w-6 lg:pr-8">
                        <div class="text-900 font-normal text-6xl sm:text-7xl xl:text-8xl mb-4">Pricing</div>
                        <h4 class="text-900 font-normal mb-4 lg:mb-0 line-height-3" style="letter-spacing: 0.6px">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Velitnumquam eligendi quos.</h4>
                    </div>
                ...
                <div class="flex flex-wrap mt-5 -mx-3">
                    <div class="w-full lg:w-4 p-3">
                        <div class="p-4 h-full surface-card" style="border-radius: 24px">
                            <div class="font-medium text-xl mb-5 text-900">Free Forever</div>
                            <div class="font-bold text-5xl mb-5 text-900">Free</div>
                            <Button label="Create Account" icon="pi pi-arrow-right" iconPos="right" size="large" class="lg:w-full font-medium p-2" outlined></Button>
                            <p class="text-sm line-height-3 mb-0 mt-5 line-height-3">Lorem ipsum dolor sit, amet consectetur adipisicing elit.</p>
                        </div>
                    </div>
                    <div class="w-full lg:w-4 p-3">
                        <div class="p-4 h-full surface-card" style="border-radius: 24px">
                            ...
                            <Button label="Proceed Monthly" icon="pi pi-arrow-right" iconPos="right" size="large" class="lg:w-full font-medium p-2"></Button>
                            <p class="text-sm line-height-3 mb-0 mt-5">Nec ultrices dui sapien eget. Amet nulla facilisi morbi tempus.</p>
                        </div>
                    </div>
                    <div class="w-full lg:w-4 p-3">
                        <div class="p-4 h-full flex flex-column surface-card" style="border-radius: 24px">
                            <div class="flex flex-row justify-content-between mb-5 align-items-center">
                                <div class="text-900 text-xl font-medium">Yearly</div>
                                <span class="500 text-green-500 font-semibold px-2 py-1 border-round" style="background-color: rgba(76, 175, 80, 0.1)">🎉 Save 20%</span>
                            </div>
                            <div class="flex align-items-center mb-5">
                                <span class="text-900 font-bold text-5xl">$275</span>
                                <span class="font-medium text-500 ml-2">per year</span>
                            </div>
                            <Button label="Proceed Yearly" icon="pi pi-arrow-right" iconPos="right" size="large" class="lg:w-full font-medium p-2"></Button>
            ...
            <div class="pt-8 pb-6">
                <div class="grid pb-6 border-bottom-1 border-300">
                    <div class="col-12 md:col-3">
                        ...
                        <a class="text-700 block cursor-pointer line-height-3 mb-2 hover:text-primary transition-duration-200">About Us</a>
                        <a class="text-700 block cursor-pointer line-height-3 mb-2 hover:text-primary transition-duration-200">News</a>
                        <a class="text-700 block cursor-pointer line-height-3 mb-2 hover:text-primary transition-duration-200">Investor Relations</a>
                        <a class="text-700 block cursor-pointer line-height-3 mb-2 hover:text-primary transition-duration-200">Careers</a>
                        <a class="text-700 block cursor-pointer line-height-3 hover:text-primary transition-duration-200">Media Kit</a>
                    </div>
                    <div class="col-12 md:col-3">
                        <div class="text-900 font-bold line-height-3 mb-3">Resourses</div>
                        <a class="text-700 block cursor-pointer line-height-3 mb-2 hover:text-primary transition-duration-200">Get Started</a>
                        <a class="text-700 block cursor-pointer line-height-3 mb-2 hover:text-primary transition-duration-200">Learn</a>
                        <a class="text-700 block cursor-pointer line-height-3 hover:text-primary transition-duration-200">Case Studies</a>
                    </div>
                    <div class="col-12 md:col-3">
                        <div class="text-900 font-bold line-height-3 mb-3">Community</div>
                        <a class="text-700 block cursor-pointer line-height-3 mb-2 hover:text-primary transition-duration-200">Discord</a>
                        <a class="text-700 block cursor-pointer line-height-3 mb-2 hover:text-primary transition-duration-200">Events</a>
                        <a class="text-700 block cursor-pointer line-height-3 mb-2 hover:text-primary transition-duration-200">FAQ</a>
                        <a class="text-700 block cursor-pointer line-height-3 hover:text-primary transition-duration-200">Blog</a>
                    </div>
                    <div class="col-12 md:col-3">
                        <div class="text-700 line-height-3 mb-3">Join our community to get weekly updates and unique gifts every friday.</div>
                        <InputText placeholder="Enter your email" class="w-full" />
                        <Button label="Join" class="px-5 mt-3 py-3"></Button>
                    </div>
                </div>
                <div class="flex flex-wrap align-items-center justify-content-between mt-6">
                    ...
                    <div class="flex align-items-center justify-content-between md:mb-0 mb-3">
                        <a class="text-700 cursor-pointer md:ml-5 ml-2 hover:text-primary transition-duration-200">Brand Policy</a>
                        <a class="text-700 cursor-pointer md:ml-5 ml-2 hover:text-primary transition-duration-200">Privacy Policy</a>
                        <a class="text-700 cursor-pointer md:ml-5 ml-2 hover:text-primary transition-duration-200">Terms of Service</a>
                    </div>
                    <div class="flex align-items-center justify-content-between">
                        <a class="cursor-pointer text-500 md:ml-3 ml-2 hover:text-primary transition-duration-200">
