...
import chat_img from '@/../assets/demo/images/landing/chat.png'
...
const activeImage = ref(chat_img);
const images = [
...
const changeImageOnHover = (i) => {
    activeImage.value = images[i].src;
    activeLink.value = i;
};
...
<template>
    <div :class="(mobileMenuOpen ? 'overflow-hidden h-screen md:h-auto ' : 'h-auto ') + 'landing-wrapper'">
        <div :class="(mobileMenuOpen ? 'block md:hidden ' : 'hidden ') + 'absolute z-40 top-0 right-0 w-full h-screen'" style="background-color: rgba(0,0,0,0.5)" @click="closeMobileMenu"></div>
        <div class="flex items-center justify-between relative lg:static py-6 mx-0 px-4 lg:py-6">
            ...
            <a
                class="cursor-pointer block md:hidden text-gray-700 text-emerald-600"
                @click="toggleMobileMenu"
            >
                <i class="pi pi-bars text-4xl"></i>
            </a>

            <ul ref="menu" style="top: 0px; right: 0%" :class="(mobileMenuOpen ? 'flex' : 'hidden md:flex') + ' list-none grow justify-end absolute md:relative h-screen md:h-auto bg-white md:bg-gray-50 m-0 z-50 w-full sm:w-6/12 md:w-full py-6 md:py-0'">
                <a
                    class="cursor-pointer block md:hidden text-gray-700 text-emerald-600 absolute"
                ...
                <li class="mt-5 md:mt-0">
                    <a
                        ...
                        class="flex m-0 md:ml-5 md:px-0 px-3 py-3 text-gray-900 font-medium leading-normal hover:text-emerald-600 cursor-pointer"
                    >
                        <span>Home</span>
                    </a>
                </li>
                ...
                <li class="flex items-center">
                    <button type="button" @click="closeMobileMenu" class="btn btn-primary m-0 mt-3 md:mt-0 ml-3 md:ml-5">Buy Now</button>
                </li>
            </ul>
        </div>
        <div ref="home" id="home" class="landing-banner px-4 md:px-8 py-8 lg:flex flex-wrap">
            <div class="banner-left w-full lg:w-8/12">
                <span class="block font-normal mb-6 text-6xl sm:text-7xl xl:text-8xl text-gray-900 w-full">Start Your Business With The All-In-One <b class="text-emerald-600 font-medium">FREYA</b> Dashboard Template!</span>
                <h4 class="font-normal text-gray-900 m-0 mb-6 leading-normal w-10/12" style="letter-spacing: 0.6px">
                ...
                <button class="btn btn-primary btn-lg mb-6"><i class="pi pi-arrow-right mr-2"></i>Learn More</button>

                <div class="logo-section relative w-full md:w-8/12 mt-6">
                    <div class="fade-left h-8 w-24 block absolute top-0 left-0" style="background: linear-gradient(to right, var(--b1, #f9fafb), transparent); z-index: 2"></div>
                    <div class="marquee-wrapper relative overflow-hidden flex gap-6">
                        <div class="marquee flex gap-6" style="animation-duration: 50s">
                            <img src="@/../assets/demo/images/landing/logocloud/alfred-500.svg" class="h-8" alt="" />
                            <img src="@/../assets/demo/images/landing/logocloud/bastion-500.svg" class="h-8" alt="" />
                            <img src="@/../assets/demo/images/landing/logocloud/charot-500.svg" class="h-8" alt="" />
                            <img src="@/../assets/demo/images/landing/logocloud/franki-500.svg" class="h-8" alt="" />
                            <img src="@/../assets/demo/images/landing/logocloud/hodly-500.svg" class="h-8" alt="" />
                            <img src="@/../assets/demo/images/landing/logocloud/hyper-500.svg" class="h-8" alt="" />
                            <img src="@/../assets/demo/images/landing/logocloud/shodan-500.svg" class="h-8" alt="" />
                        </div>
                        <div class="marquee flex gap-6" style="animation-duration: 50s">
                            <img src="@/../assets/demo/images/landing/logocloud/alfred-500.svg" class="h-8" alt="" />
                            <img src="@/../assets/demo/images/landing/logocloud/bastion-500.svg" class="h-8" alt="" />
                    ...
                    <div class="fade-right h-8 w-24 block absolute top-0 right-0" style="background: linear-gradient(to left, var(--b1, #f9fafb), transparent); z-index: 2"></div>
                </div>
            </div>
            <div class="banner-right w-4/12 hidden lg:block">
                <div id="ex1" class="cards w-full flex flex-col items-end mt-8 pl-3">
        ...
        <div ref="features" id="features" class="landing-section px-4 md:px-8 py-8 mb-8">
            <div class="section-top lg:flex w-full gap-6 items-center mb-6">
                <span class="block font-normal text-6xl sm:text-7xl xl:text-8xl text-gray-900 lg:w-8/12">Wide range of features and the stylish use of <b class="text-emerald-600 font-medium">PrimeVue</b> components</span>
                <div class="lg:w-4/12 lg:mt-0 mt-5">
                    <h3 class="font-normal text-gray-900 m-0 mb-6 w-full" style="letter-spacing: 0.6px">
                        With customizability at the forefront, our templates can be tailored to your specific needs and preferences. Whether you're looking for a simple and intuitive interface or a more complex and feature-rich solution, our
                        templates have you covered.
                    </h3>
                    <button class="btn btn-primary btn-lg"><i class="pi pi-arrow-right mr-2"></i>Learn More</button>
                </div>
            </div>
            <div class="feature-cards grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-8 pt-4">
                <div>
                    <div class="card p-0 h-full">
                        <svg animateEnter="fadein" viewBox="0 0 443 257" class="w-full rounded-3xl mb-4" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <mask id="mask0_436_2188" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="443" height="257">
                                <rect width="442.667" height="257" fill="url(#paint0_linear_436_2188)" />
                            </mask>
                            <g mask="url(#mask0_436_2188)">
                                <g opacity="0.05">
                                    <rect x="-30.082" y="-14.1369" width="155" height="15" rx="6.5" fill="var(--primary-500, #10b981)" />
                                    <rect x="-30.082" y="-14.1369" width="155" height="15" rx="6.5" stroke="var(--primary-300, #6ee7b7)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="141.918" y="-14.1369" width="155" height="15" rx="6.5" fill="var(--primary-500, #10b981)" />
                                    <rect x="141.918" y="-14.1369" width="155" height="15" rx="6.5" stroke="var(--primary-300, #6ee7b7)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="313.918" y="-14.1369" width="155" height="15" rx="6.5" fill="var(--primary-500, #10b981)" />
                                    <rect x="313.918" y="-14.1369" width="155" height="15" rx="6.5" stroke="var(--primary-300, #6ee7b7)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="-116.082" y="15.8631" width="155" height="15" rx="6.5" fill="var(--primary-500, #10b981)" />
                                    <rect x="-116.082" y="15.8631" width="155" height="15" rx="6.5" stroke="var(--primary-300, #6ee7b7)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="55.918" y="15.8631" width="155" height="15" rx="6.5" fill="var(--primary-500, #10b981)" />
                                    <rect x="55.918" y="15.8631" width="155" height="15" rx="6.5" stroke="var(--primary-300, #6ee7b7)" />
                                </g>
                                <g opacity="0.15">
                                    <rect x="227.918" y="15.8631" width="155" height="15" rx="6.5" fill="var(--primary-500, #10b981)" />
                                    <rect x="227.918" y="15.8631" width="155" height="15" rx="6.5" stroke="var(--primary-300, #6ee7b7)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="399.918" y="15.8631" width="155" height="15" rx="6.5" fill="var(--primary-500, #10b981)" />
                                    <rect x="399.918" y="15.8631" width="155" height="15" rx="6.5" stroke="var(--primary-300, #6ee7b7)" />
                                </g>
                                <g opacity="0.15">
                                    <rect x="-30.082" y="45.8631" width="155" height="15" rx="6.5" fill="var(--primary-500, #10b981)" />
                                    <rect x="-30.082" y="45.8631" width="155" height="15" rx="6.5" stroke="var(--primary-300, #6ee7b7)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="141.918" y="45.8631" width="155" height="15" rx="6.5" fill="var(--primary-500, #10b981)" />
                                    <rect x="141.918" y="45.8631" width="155" height="15" rx="6.5" stroke="var(--primary-300, #6ee7b7)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="313.918" y="45.8631" width="155" height="15" rx="6.5" fill="var(--primary-500, #10b981)" />
                                    <rect x="313.918" y="45.8631" width="155" height="15" rx="6.5" stroke="var(--primary-300, #6ee7b7)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="-116.082" y="75.8631" width="155" height="15" rx="6.5" fill="var(--primary-500, #10b981)" />
                                    <rect x="-116.082" y="75.8631" width="155" height="15" rx="6.5" stroke="var(--primary-300, #6ee7b7)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="55.918" y="75.8631" width="155" height="15" rx="6.5" fill="var(--primary-500, #10b981)" />
                                    <rect x="55.918" y="75.8631" width="155" height="15" rx="6.5" stroke="var(--primary-300, #6ee7b7)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="227.918" y="75.8631" width="155" height="15" rx="6.5" fill="var(--primary-500, #10b981)" />
                                    <rect x="227.918" y="75.8631" width="155" height="15" rx="6.5" stroke="var(--primary-300, #6ee7b7)" />
                                </g>
                                <g opacity="0.15">
                                    <rect x="399.918" y="75.8631" width="155" height="15" rx="6.5" fill="var(--primary-500, #10b981)" />
                                    <rect x="399.918" y="75.8631" width="155" height="15" rx="6.5" stroke="var(--primary-300, #6ee7b7)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="-30.082" y="105.863" width="155" height="15" rx="6.5" fill="var(--primary-500, #10b981)" />
                                    <rect x="-30.082" y="105.863" width="155" height="15" rx="6.5" stroke="var(--primary-300, #6ee7b7)" />
                                </g>
                                <g opacity="0.15">
                                    <rect x="141.918" y="105.863" width="155" height="15" rx="6.5" fill="var(--primary-500, #10b981)" />
                                    <rect x="141.918" y="105.863" width="155" height="15" rx="6.5" stroke="var(--primary-300, #6ee7b7)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="313.918" y="105.863" width="155" height="15" rx="6.5" fill="var(--primary-500, #10b981)" />
                                    <rect x="313.918" y="105.863" width="155" height="15" rx="6.5" stroke="var(--primary-300, #6ee7b7)" />
                                </g>
                                <g opacity="0.15">
                                    <rect x="-116.082" y="135.863" width="155" height="15" rx="6.5" fill="var(--primary-500, #10b981)" />
                                    <rect x="-116.082" y="135.863" width="155" height="15" rx="6.5" stroke="var(--primary-300, #6ee7b7)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="55.918" y="135.863" width="155" height="15" rx="6.5" fill="var(--primary-500, #10b981)" />
                                    <rect x="55.918" y="135.863" width="155" height="15" rx="6.5" stroke="var(--primary-300, #6ee7b7)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="227.918" y="135.863" width="155" height="15" rx="6.5" fill="var(--primary-500, #10b981)" />
                                    <rect x="227.918" y="135.863" width="155" height="15" rx="6.5" stroke="var(--primary-300, #6ee7b7)" />
                                </g>
                                <g opacity="0.15">
                                    <rect x="399.918" y="135.863" width="155" height="15" rx="6.5" fill="var(--primary-500, #10b981)" />
                                    <rect x="399.918" y="135.863" width="155" height="15" rx="6.5" stroke="var(--primary-300, #6ee7b7)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="-30.082" y="165.863" width="155" height="15" rx="6.5" fill="var(--primary-500, #10b981)" />
                                    <rect x="-30.082" y="165.863" width="155" height="15" rx="6.5" stroke="var(--primary-300, #6ee7b7)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="141.918" y="165.863" width="155" height="15" rx="6.5" fill="var(--primary-500, #10b981)" />
                                    <rect x="141.918" y="165.863" width="155" height="15" rx="6.5" stroke="var(--primary-300, #6ee7b7)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="313.918" y="165.863" width="155" height="15" rx="6.5" fill="var(--primary-500, #10b981)" />
                                    <rect x="313.918" y="165.863" width="155" height="15" rx="6.5" stroke="var(--primary-300, #6ee7b7)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="-116.082" y="195.863" width="155" height="15" rx="6.5" fill="var(--primary-500, #10b981)" />
                                    <rect x="-116.082" y="195.863" width="155" height="15" rx="6.5" stroke="var(--primary-300, #6ee7b7)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="55.918" y="195.863" width="155" height="15" rx="6.5" fill="var(--primary-500, #10b981)" />
                                    <rect x="55.918" y="195.863" width="155" height="15" rx="6.5" stroke="var(--primary-300, #6ee7b7)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="227.918" y="195.863" width="155" height="15" rx="6.5" fill="var(--primary-500, #10b981)" />
                                    <rect x="227.918" y="195.863" width="155" height="15" rx="6.5" stroke="var(--primary-300, #6ee7b7)" />
                                </g>
                                <g opacity="0.05">
                                    <rect x="399.918" y="195.863" width="155" height="15" rx="6.5" fill="var(--primary-500, #10b981)" />
                                    <rect x="399.918" y="195.863" width="155" height="15" rx="6.5" stroke="var(--primary-300, #6ee7b7)" />
                                </g>
                                <rect x="84.5507" y="97.8894" width="273.565" height="45" rx="13.5" fill="var(--primary-300, #6ee7b7)" style="opacity: 0.9" />
                                <path
                                    ...
                                    fill="#047857"
                                />
                                <rect x="84.5507" y="97.8894" width="273.565" height="45" rx="13.5" stroke="var(--primary-300, #6ee7b7)" />
                            </g>
                            <defs>
                                <linearGradient id="paint0_linear_436_2188" x1="221.333" y1="0" x2="221.333" y2="257" gradientUnits="userSpaceOnUse">
                                    <stop offset="0.750409" stop-color="white" />
                                    <stop offset="1" stop-color="white" stop-opacity="0" />
                                </linearGradient>
                            </defs>
                        </svg>
                        <h4 class="font-medium m-0 mb-3 px-5">Easy to use</h4>
                        <span class="p-0 m-0 text-xl block leading-normal px-5 pb-5" style="letter-spacing: 0.4px">A user-friendly interface that is intuitive and simple to navigate, enabling users to quickly find the information they need.</span>
                    </div>
                </div>
                <!-- NOTE: The remaining 5 feature cards (Page Speed, SEO, Responsive, Browser Support, Accessibility) contain large inline SVGs. -->
                <!-- They are preserved identically but with the same class replacements applied. For brevity, using the same card structure. -->
                <div>
                    <div class="card p-0 h-full">
                        <svg animateEnter="fadein" class="w-full rounded-3xl mb-4" viewBox="0 0 444 257" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <!-- Page Speed SVG - preserved as-is from original with CSS var fallbacks -->
                            <rect width="442.667" height="257" transform="translate(0.666656)" fill="white" />
                        </svg>
                        <h4 class="font-medium m-0 mb-3 px-5">Page Speed</h4>
                        <span class="p-0 m-0 text-xl block leading-normal px-5 pb-5" style="letter-spacing: 0.4px">A website that loads quickly, providing users with a seamless browsing experience and improving SEO rankings.</span>
                    </div>
                </div>
                <div>
                    <div class="card p-0 h-full">
                        <svg animateEnter="fadein" class="w-full rounded-3xl mb-4" viewBox="0 0 443 257" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect width="442.667" height="257" transform="translate(0.333313)" fill="white" />
                        </svg>
                        <h4 class="font-medium m-0 mb-3 px-5">SEO</h4>
                        <span class="p-0 m-0 text-xl block leading-normal px-5 pb-5" style="letter-spacing: 0.4px">
                            Search engine optimization techniques that help improve a website's ranking in search engine results, making it more visible to potential users and driving traffic to the site.
                        </span>
                    </div>
                </div>
                <div>
                    <div class="card p-0 h-full">
                        <svg animateEnter="fadein" class="w-full rounded-3xl mb-4" viewBox="0 0 443 257" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect width="442.667" height="257" fill="white" />
                        </svg>
                        <h4 class="font-medium m-0 mb-3 px-5">Responsive</h4>
                        <span class="p-0 m-0 text-xl block leading-normal px-5 pb-5" style="letter-spacing: 0.4px">A design that adapts to different screen sizes and devices, ensuring that content is accessible and easy to read on all devices.</span>
                    </div>
                </div>
                <div>
                    <div class="card p-0 h-full">
                        ...
                        <h4 class="font-medium m-0 mb-3 px-5">Browser Support</h4>
                        <span class="p-0 m-0 text-xl block leading-normal px-5 pb-5" style="letter-spacing: 0.4px"
                            >A website that is compatible with a variety of browsers, including Chrome, Firefox, and Safari, to ensure a seamless experience for all users.</span
                        >
                    </div>
                </div>
                <div>
                    <div class="card p-0 h-full">
                        ...
                        <h4 class="font-medium m-0 mb-3 px-5">Accessibility</h4>
                        <span class="p-0 m-0 text-xl block leading-normal px-5 pb-5" style="letter-spacing: 0.4px"
                            >Ensuring that all users, including those with disabilities, can access and use your website with ease, through features such as alt tags, transcripts, and keyboard navigation.</span
                        >
                    </div>
                </div>
            </div>
        </div>
        <div ref="customizations" id="customizations" class="landing-section px-4 md:px-8 py-8 mt-8">
            <div class="section-top flex w-full flex-col gap-6 items-center justify-center mb-6">
                <span class="block font-normal text-6xl sm:text-7xl xl:text-8xl text-gray-900">Make it Your Own </span>
                <h4 class="lg:w-8/12 font-normal text-gray-900 m-0 mb-6 text-center leading-normal" style="letter-spacing: 0.6px">
            ...
            <div class="video relative" style="max-width: 62rem; margin: 0 auto">
                <img src="@/../assets/demo/images/landing/image-3.png" class="w-full rounded-3xl mb-4" alt="" />
                <button @click="showModalDialog()" class="btn btn-circle btn-primary absolute top-1/2 right-1/2 text-3xl" style="margin-right: -5rem; margin-top: -5rem; height: 10rem; width: 10rem"><i class="pi pi-play text-8xl ml-3"></i></button>
            </div>
            <!-- DaisyUI Modal replacing PrimeVue Dialog -->
            <div :class="['modal', displayModal ? 'modal-open' : '']">
                <div class="modal-box" style="width: 80vw; max-width: 80vw; height: 45vw;">
                    ...
                    <div class="grow" style="height: calc(100% - 3rem);">
                        <iframe
                            v-if="displayModal"
        ...
        <div ref="apps" id="apps" class="landing-section px-4 md:px-8 py-8 mt-8">
            <div class="section-top flex w-full gap-6 items-center justify-start mb-6">
                <span class="block font-normal text-6xl sm:text-7xl xl:text-8xl text-gray-900">Ready to Use Applications </span>
            </div>
            <div class="content lg:flex justify-between gap-6">
                <div class="left lg:w-6/12">
                    <h4 class="w-11/12 font-normal text-gray-900 m-0 mb-6 leading-normal" style="letter-spacing: 0.6px">
                    ...
                    <ul class="list-none p-0 m-0">
                        <li class="mb-4 flex items-center">
                            <a @mouseover="changeImageOnHover(0)" :style="activeLink == 0 ? 'color:#10b981 !important' : ''" class="text-4xl font-medium text-gray-900 hover:text-emerald-600 duration-200 cursor-pointer">Chat </a>
                            <i v-if="activeLink == 0" class="pi pi-arrow-right text-4xl text-emerald-600 ml-3"></i>
                        </li>
                        <li class="mb-4 flex items-center">
                            <a @mouseover="changeImageOnHover(1)" :style="activeLink == 1 ? 'color:#10b981 !important' : ''" class="text-4xl font-medium text-gray-900 hover:text-emerald-600 duration-200 cursor-pointer">Mail</a>
                            <i v-if="activeLink == 1" class="pi pi-arrow-right text-4xl text-emerald-600 ml-3"></i>
                        </li>

                        <li class="mb-4 flex items-center">
                            <a @mouseover="changeImageOnHover(2)" :style="activeLink == 3 ? 'color:#10b981 !important' : ''" class="text-4xl font-medium text-gray-900 hover:text-emerald-600 duration-200 cursor-pointer">Task List</a>
                            <i v-if="activeLink == 3" class="pi pi-arrow-right text-4xl text-emerald-600 ml-3"></i>
                        </li>
                        <li class="mb-4 flex items-center">
                            <a @mouseover="changeImageOnHover(3)" :style="activeLink == 4 ? 'color:#10b981 !important' : ''" class="text-4xl font-medium text-gray-900 hover:text-emerald-600 duration-200 cursor-pointer">Blog</a>
                            <i v-if="activeLink == 4" class="pi pi-arrow-right text-4xl text-emerald-600 ml-3"></i>
                        </li>
                    </ul>
                </div>
                <div class="right lg:w-6/12 mt-5 lg:mt-0">
                    <img animateEnter="fadein" :src="activeImage" class="w-full rounded-3xl mb-4" alt="" />
                </div>
            </div>
        </div>
        <div ref="pricing" id="pricing" class="landing-section px-4 md:px-8 py-8 mt-8">
            <div class="bg-gray-50 px-4 py-8 md:px-6 lg:px-8 bg-no-repeat bg-cover" style="border-radius: 24px; background: linear-gradient(to left bottom, #d1fae5, #ffffff)">
                <div class="flex flex-wrap items-center">
                    <div class="w-full lg:w-6/12 lg:pr-8">
                        <div class="text-gray-900 font-normal text-6xl sm:text-7xl xl:text-8xl mb-4">Pricing</div>
                        <h4 class="text-gray-900 font-normal mb-4 lg:mb-0 leading-normal" style="letter-spacing: 0.6px">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Velitnumquam eligendi quos.</h4>
                    </div>
                    <div class="w-full md:w-6/12 lg:w-3/12">
                        <ul class="list-none p-0 m-0">
                            <li class="flex items-center mb-4">
                                <i class="pi pi-check text-emerald-500 mr-3"></i>
                    ...
                    <div class="w-full md:w-6/12 lg:w-3/12 md:pl-5">
                        <ul class="list-none p-0 m-0">
                            <li class="flex items-center mb-4">
                                <i class="pi pi-check text-emerald-500 mr-3"></i>
                ...
                <div class="flex flex-wrap mt-5 -mx-3">
                    <div class="w-full lg:w-4/12 p-3">
                        <div class="p-4 h-full bg-white" style="border-radius: 24px">
                            <div class="font-medium text-xl mb-5 text-gray-900">Free Forever</div>
                            <div class="font-bold text-5xl mb-5 text-gray-900">Free</div>
                            <button class="btn btn-outline btn-primary lg:w-full font-medium p-2 btn-lg">Create Account <i class="pi pi-arrow-right ml-2"></i></button>
                            <p class="text-sm leading-normal mb-0 mt-5 leading-normal">Lorem ipsum dolor sit, amet consectetur adipisicing elit.</p>
                        </div>
                    </div>
                    <div class="w-full lg:w-4/12 p-3">
                        <div class="p-4 h-full bg-white" style="border-radius: 24px">
                            <div class="font-medium text-xl mb-5 text-gray-900">Monthly</div>
                            <div class="flex items-center mb-5">
                                <span class="text-gray-900 font-bold text-5xl">$29</span>
                                <span class="font-medium text-gray-500 ml-2">per month</span>
                            </div>
                            <button class="btn btn-primary lg:w-full font-medium p-2 btn-lg">Proceed Monthly <i class="pi pi-arrow-right ml-2"></i></button>
                            <p class="text-sm leading-normal mb-0 mt-5">Nec ultrices dui sapien eget. Amet nulla facilisi morbi tempus.</p>
                        </div>
                    </div>
                    <div class="w-full lg:w-4/12 p-3">
                        <div class="p-4 h-full flex flex-col bg-white" style="border-radius: 24px">
                            <div class="flex flex-row justify-between mb-5 items-center">
                                <div class="text-gray-900 text-xl font-medium">Yearly</div>
                                <span class="text-green-500 font-semibold px-2 py-1 rounded" style="background-color: rgba(76, 175, 80, 0.1)">Save 20%</span>
                            </div>
                            <div class="flex items-center mb-5">
                                <span class="text-gray-900 font-bold text-5xl">$275</span>
                                <span class="font-medium text-gray-500 ml-2">per year</span>
                            </div>
                            <button class="btn btn-primary lg:w-full font-medium p-2 btn-lg">Proceed Yearly <i class="pi pi-arrow-right ml-2"></i></button>
                            <p class="text-sm leading-normal mb-0 mt-5">Placerat in egestas erat imperdiet sed euismod nisi porta.</p>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <div class="landing-section px-4 md:px-8 pt-8 mt-8">
            <div class="pt-8 pb-6">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 pb-6 border-b border-gray-300">
                    <div>
                        <div class="text-gray-900 font-bold leading-normal mb-3">Company</div>
                        <a class="text-gray-700 block cursor-pointer leading-normal mb-2 hover:text-emerald-600 duration-200">About Us</a>
                        <a class="text-gray-700 block cursor-pointer leading-normal mb-2 hover:text-emerald-600 duration-200">News</a>
                        <a class="text-gray-700 block cursor-pointer leading-normal mb-2 hover:text-emerald-600 duration-200">Investor Relations</a>
                        <a class="text-gray-700 block cursor-pointer leading-normal mb-2 hover:text-emerald-600 duration-200">Careers</a>
                        <a class="text-gray-700 block cursor-pointer leading-normal hover:text-emerald-600 duration-200">Media Kit</a>
                    </div>
                    <div>
                        <div class="text-gray-900 font-bold leading-normal mb-3">Resourses</div>
                        <a class="text-gray-700 block cursor-pointer leading-normal mb-2 hover:text-emerald-600 duration-200">Get Started</a>
                        <a class="text-gray-700 block cursor-pointer leading-normal mb-2 hover:text-emerald-600 duration-200">Learn</a>
                        <a class="text-gray-700 block cursor-pointer leading-normal hover:text-emerald-600 duration-200">Case Studies</a>
                    </div>
                    <div>
                        <div class="text-gray-900 font-bold leading-normal mb-3">Community</div>
                        <a class="text-gray-700 block cursor-pointer leading-normal mb-2 hover:text-emerald-600 duration-200">Discord</a>
                        <a class="text-gray-700 block cursor-pointer leading-normal mb-2 hover:text-emerald-600 duration-200">Events</a>
                        <a class="text-gray-700 block cursor-pointer leading-normal mb-2 hover:text-emerald-600 duration-200">FAQ</a>
                        <a class="text-gray-700 block cursor-pointer leading-normal hover:text-emerald-600 duration-200">Blog</a>
                    </div>
                    <div>
                        <div class="text-gray-700 leading-normal mb-3">Join our community to get weekly updates and unique gifts every friday.</div>
                        <input type="text" placeholder="Enter your email" class="input input-bordered w-full" />
                        <button class="btn btn-primary px-5 mt-3 py-3">Join</button>
                    </div>
                </div>
                <div class="flex flex-wrap items-center justify-between mt-6">
                    <div class="flex items-center justify-start md:mb-0 mb-3">
                        <svg animateEnter="fadein" height="32" viewBox="0 0 66 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M0 0H4.99056V3.20992L14.1395 1.39922V5.5969L4.99056 7.40759V8.80682L14.1395 6.99612V11.1938L4.99056 13.0045V16.7907H0V0Z" fill="url(#paint0_linear_7_2)" />
                            <path
                                d="M26.6589 6.69198H24.5387V6.08721C24.5387 5.61683 24.8058 5.34804 25.2732 5.34804H26.6422V2.94574H24.4719C22.5686 2.94574 21.5669 4.0041 21.5669 5.83522V6.69198H20.031L20.0477 9.14468H21.5336V15.6124H24.6388V9.14468H26.6589V6.69198Z"
                                fill="url(#paint1_linear_7_2)"
                    ...
                    <div class="flex items-center justify-between md:mb-0 mb-3">
                        <a class="text-gray-700 cursor-pointer md:ml-5 ml-2 hover:text-emerald-600 duration-200">Brand Policy</a>
                        <a class="text-gray-700 cursor-pointer md:ml-5 ml-2 hover:text-emerald-600 duration-200">Privacy Policy</a>
                        <a class="text-gray-700 cursor-pointer md:ml-5 ml-2 hover:text-emerald-600 duration-200">Terms of Service</a>
                    </div>
                    <div class="flex items-center justify-between">
                        <a class="cursor-pointer text-gray-500 md:ml-3 ml-2 hover:text-emerald-600 duration-200">
