...
import asset_weather from "@/../assets/demo/images/rightpanel/asset-weather.png"
  ...
  >
    <div class="p-0 py-3weather-section">
      ...
      <div
        ...
        :style="`
          ...
          background-image: url('${asset_weather}');
        `"
      >
        <img
        ...
        />
        <div class="ml-3">
          <h6 class="m-0 mb-1" style="color: rgb(83 88 99)">Ankara, 22 May</h6>
          <h1 class="m-0" style="color: rgb(83 88 99)">24º</h1>
        </div>
      </div>
    </div>
    ...
    <div class="rightpanel-section mt-4">
      ...
      <ul class="list-none p-0 m-0 overflow-auto" style="max-height: 330px">
        <li
          class="p-3 border-round-lg surface-0 mb-3 flex align-items-center justify-content-between"
        >
          <div>
        ...
        >
          <div>
            ...
            <span class="text-400 line-height-3 block font-medium"
              >Ravensburger Seurat, 2000</span
            >
          </div>
        </li>
        <li
          class="opacity-50 p-3 border-round-lg surface-0 mb-3 flex align-items-center justify-content-between"
        >
          <div>
      ...
      <div class="favorite-items flex align-items-center flex-wrap" style="margin: -7px">
        <a
          ...
          style="
            width: 80px;
            height: 80px;
            box-shadow: 0px 0px 2px rgba(41, 50, 65, 0.3),
