  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (link.icon === "home") {
                ...
                _push2(`<span class="relative inline-block mr-1.5 -mt-0.5"${_scopeId}><svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"${_scopeId}></path></svg>`);
                if (profileMissing.value > 0) {
                  _push2(`<span class="absolute -top-1.5 -right-2 min-w-[14px] h-3.5 px-1 flex items-center justify-center rounded-full bg-error text-white text-[8px] font-bold leading-none"${_scopeId}>${ssrInterpolate(profileMissing.value)}</span>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</span>`);
              ...
              return [
                link.icon === "home" ? (openBlock(), createBlock("svg", {
                ...
                ])) : link.icon === "user" ? (openBlock(), createBlock("span", {
                  key: 3,
                  class: "relative inline-block mr-1.5 -mt-0.5"
                }, [
                  (openBlock(), createBlock("svg", {
                  ...
                  profileMissing.value > 0 ? (openBlock(), createBlock("span", {
                    key: 0,
                    class: "absolute -top-1.5 -right-2 min-w-[14px] h-3.5 px-1 flex items-center justify-center rounded-full bg-error text-white text-[8px] font-bold leading-none"
                  }, toDisplayString(profileMissing.value), 1)) : createCommentVNode("", true)
      ...
      if (!isAuthenticated.value) {
        ...
        _push(`<div class="profile-dropdown relative"><button class="relative rounded-full overflow-visible border-2 border-primary/30 cursor-pointer p-0 bg-transparent transition-all hover:border-primary">`);
        ...
        if (profileMissing.value > 0) {
          _push(`<span class="absolute -top-1 -right-1 w-4 h-4 flex items-center justify-center rounded-full bg-error text-white text-[9px] font-bold leading-none ring-2 ring-base-100">${ssrInterpolate(profileMissing.value)}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</button>`);
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                if (tab.icon === "home") {
                  ...
                  _push2(`<div class="relative mb-1"${_scopeId}><svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"${_scopeId}></path></svg>`);
                  if (profileMissing.value > 0) {
                    _push2(`<span class="absolute -top-1.5 -right-2.5 w-4 h-4 flex items-center justify-center rounded-full bg-error text-white text-[9px] font-bold leading-none"${_scopeId}>${ssrInterpolate(profileMissing.value)}</span>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  _push2(`</div>`);
                ...
                return [
                  ...
                  ])) : tab.icon === "user" ? (openBlock(), createBlock("div", {
                    key: 4,
                    class: "relative mb-1"
                  }, [
                    (openBlock(), createBlock("svg", {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main class="${ssrRenderClass(__props.fullWidth ? "pb-20 lg:pb-0" : "pb-20 lg:pb-6 pt-4 px-4 lg:px-8 max-w-5xl mx-auto")}"><div>`);
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({ fullWidth: __props.fullWidth }, _attrs), {
