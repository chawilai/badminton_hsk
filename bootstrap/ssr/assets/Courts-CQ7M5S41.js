    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="space-y-4 pb-4"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><h1 class="text-base font-bold text-base-content m-0"${_scopeId}>${ssrInterpolate(unref(t)("courts.title"))}</h1><div class="flex gap-2"${_scopeId}><a href="/courts/map" class="btn btn-outline btn-success btn-sm gap-1 no-underline"${_scopeId}><svg class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"${_scopeId}><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"${_scopeId}></path></svg> แผนที่ </a><button class="btn btn-primary btn-sm gap-1"${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor"${_scopeId}><path fill-rule="evenodd" d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" clip-rule="evenodd"${_scopeId}></path></svg> ${ssrInterpolate(unref(t)("courts.addCourt"))}</button></div></div>`);
              ...
              createVNode("div", { class: "space-y-4 pb-4" }, [
                createVNode("div", { class: "flex items-center justify-between" }, [
                  ...
                  createVNode("div", { class: "flex gap-2" }, [
                    createVNode("a", {
                      href: "/courts/map",
                      class: "btn btn-outline btn-success btn-sm gap-1 no-underline"
                    }, [
              ...
              createVNode("dialog", {
                ...
                createVNode("div", { class: "modal-box max-w-md bg-base-100" }, [
                  ...
                  createVNode("form", {
                    ...
                    createVNode("div", { class: "form-control" }, [
                      createVNode("label", { class: "label py-1" }, [
                        createVNode("span", { class: "label-text text-xs font-semibold" }, "พิกัด (Latitude, Longitude)")
                      ]),
                      createVNode("div", { class: "flex gap-2" }, [
                        withDirectives(createVNode("input", {
                        ...
                        withDirectives(createVNode("input", {
                          ...
                          [vModelText, form.longitude]
                        ])
                      ]),
                      createVNode("label", { class: "label py-0.5" }, [
                        createVNode("span", { class: "label-text-alt text-base-content/40 text-[10px]" }, "คัดลอกจาก Google Maps หรือกดขวาบนแผนที่")
                      ])
                    ]),
                    createVNode("div", { class: "form-control" }, [
