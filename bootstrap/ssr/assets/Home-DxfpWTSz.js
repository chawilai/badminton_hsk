    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="space-y-6 pb-8 min-h-screen" data-v-7e5713cd${_scopeId}><div class="relative group max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4" data-v-7e5713cd${_scopeId}><div class="flex overflow-x-auto snap-x snap-mandatory scrollbar-hide rounded-[2.5rem] shadow-xl relative z-0 bg-base-200" style="${ssrRenderStyle({ "scroll-behavior": "smooth", "-webkit-overflow-scrolling": "touch" })}" data-v-7e5713cd${_scopeId}><!--[-->`);
            ssrRenderList(slides, (slide, i) => {
              _push2(`<div class="w-full shrink-0 snap-center relative aspect-[4/3] md:h-[420px] lg:h-[480px] overflow-hidden" data-v-7e5713cd${_scopeId}><picture data-v-7e5713cd${_scopeId}><source${ssrRenderAttr("srcset", slide.imageLg)} media="(min-width: 768px)" data-v-7e5713cd${_scopeId}><img${ssrRenderAttr("src", slide.image)} class="absolute inset-0 w-full h-full object-cover object-center transition-transform duration-700 group-hover:scale-105" alt="" data-v-7e5713cd${_scopeId}></picture><div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-black/10" data-v-7e5713cd${_scopeId}></div><div class="absolute inset-0 p-8 flex flex-col justify-end text-white" data-v-7e5713cd${_scopeId}><div class="animate-slide-up transform transition-all duration-500" data-v-7e5713cd${_scopeId}><h2 class="text-3xl md:text-5xl font-black mb-2 leading-tight tracking-tight" style="${ssrRenderStyle({ "text-shadow": "0 2px 8px rgba(0,0,0,0.5)" })}" data-v-7e5713cd${_scopeId}>${ssrInterpolate(slide.title)}</h2><p class="text-sm md:text-lg opacity-95 max-w-xl mb-6 font-medium leading-relaxed" style="${ssrRenderStyle({ "text-shadow": "0 1px 4px rgba(0,0,0,0.4)" })}" data-v-7e5713cd${_scopeId}>${ssrInterpolate(slide.subtitle)}</p><div class="flex items-center gap-4" data-v-7e5713cd${_scopeId}>`);
              ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(slide.external ? "a" : unref(Link)), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    if (!slide.external) {
                      _push3(`<span data-v-7e5713cd${_scopeId2}>→</span>`);
                    } else {
                      _push3(`<span data-v-7e5713cd${_scopeId2}>➚</span>`);
                    }
                  } else {
            ...
            _push2(`<!--]--></div><div class="absolute bottom-4 left-0 right-0 flex justify-center gap-2 z-10" data-v-7e5713cd${_scopeId}><!--[-->`);
            ssrRenderList(slides, (_2, i) => {
              _push2(`<button class="${ssrRenderClass([currentSlide.value === i ? "bg-primary w-8" : "bg-white/30 backdrop-blur-md", "w-2 h-2 rounded-full border-0 cursor-pointer transition-all duration-300 shadow-sm"])}" data-v-7e5713cd${_scopeId}></button>`);
            });
            _push2(`<!--]--></div></div>`);
            if (unref(user)) {
              _push2(`<div class="grid grid-cols-2 gap-2" data-v-7e5713cd${_scopeId}><!--[-->`);
              ssrRenderList(quickActions, (action) => {
                _push2(ssrRenderComponent(unref(Link), {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<div class="${ssrRenderClass([action.color, "w-10 h-10 rounded-xl flex items-center justify-center text-xl"])}" data-v-7e5713cd${_scopeId2}>${ssrInterpolate(action.icon)}</div><span class="text-xs font-semibold text-base-content" data-v-7e5713cd${_scopeId2}>${ssrInterpolate(action.label)}</span>`);
                      if (action.badge && unref(page).props[action.badge] > 0) {
                        _push3(`<span class="absolute top-2 right-2 min-w-[16px] h-4 px-1 flex items-center justify-center rounded-full bg-error text-white text-[9px] font-bold" data-v-7e5713cd${_scopeId2}>${ssrInterpolate(unref(page).props[action.badge])}</span>`);
                      } else {
                        _push3(`<!---->`);
                      }
                    } else {
              ...
              _push2(`<div class="bg-base-100 rounded-2xl border border-base-300 p-5 text-center" data-v-7e5713cd${_scopeId}><span class="text-4xl block mb-2" data-v-7e5713cd${_scopeId}>🏸</span><h2 class="text-lg font-bold text-base-content m-0 mb-1" data-v-7e5713cd${_scopeId}>Badminton Party</h2><p class="text-xs text-base-content/60 m-0 mb-4" data-v-7e5713cd${_scopeId}>เข้าสู่ระบบเพื่อเริ่มใช้งาน</p><div class="flex justify-center gap-2" data-v-7e5713cd${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Link), {
                href: "/login",
            ...
            _push2(`<div class="space-y-2" data-v-7e5713cd${_scopeId}><h3 class="text-sm font-bold text-base-content/70 m-0 px-1" data-v-7e5713cd${_scopeId}>คุณสมบัติ</h3><!--[-->`);
            ssrRenderList(features, (feat) => {
              _push2(`<div class="bg-base-100 rounded-xl border border-base-300 p-3 flex items-center gap-3" data-v-7e5713cd${_scopeId}><div class="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center text-xl shrink-0" data-v-7e5713cd${_scopeId}>${ssrInterpolate(feat.icon)}</div><div data-v-7e5713cd${_scopeId}><div class="text-xs font-bold text-base-content" data-v-7e5713cd${_scopeId}>${ssrInterpolate(feat.title)}</div><div class="text-[10px] text-base-content/50" data-v-7e5713cd${_scopeId}>${ssrInterpolate(feat.desc)}</div></div></div>`);
            });
            _push2(`<!--]--></div><div class="relative overflow-hidden rounded-2xl border-2 border-primary/30 p-6 text-center bg-primary/10" data-v-7e5713cd${_scopeId}><div class="absolute inset-0 bg-gradient-to-br from-primary/20 via-transparent to-accent/10 pointer-events-none" data-v-7e5713cd${_scopeId}></div><div class="relative z-10" data-v-7e5713cd${_scopeId}><span class="text-4xl block mb-3" data-v-7e5713cd${_scopeId}>🏆</span><h2 class="text-xl font-black text-primary m-0 mb-1" data-v-7e5713cd${_scopeId}>พร้อมตีแบดหรือยัง?</h2><p class="text-xs text-base-content/60 m-0 mb-5" data-v-7e5713cd${_scopeId}>เข้าร่วมปาร์ตี้ หรือดูสถิติของคุณ</p><div class="flex flex-col gap-2 max-w-xs mx-auto" data-v-7e5713cd${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: "/party-lists",
...
const Home = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7e5713cd"]]);
export {
  Home as default
};
