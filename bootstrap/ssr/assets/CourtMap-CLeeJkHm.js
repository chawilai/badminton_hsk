import { ref, computed, onMounted, nextTick, onBeforeUnmount, unref, withCtx, createVNode, createBlock, createCommentVNode, withDirectives, vModelText, openBlock, Transition, createTextVNode, toDisplayString, Fragment, renderList, useSSRContext } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, { fullWidth: true }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="relative h-[calc(100vh-3.5rem-4rem)] lg:h-[calc(100vh-4rem)]" data-v-004eff07${_scopeId}><div class="absolute inset-0 z-0" data-v-004eff07${_scopeId}></div><div class="absolute top-3 left-3 right-14 z-[1000] flex gap-2" data-v-004eff07${_scopeId}><div class="relative flex-1 max-w-xs" data-v-004eff07${_scopeId}><input${ssrRenderAttr("value", searchQuery.value)} type="text" placeholder="ค้นหาสนาม..." class="w-full h-10 pl-9 pr-3 rounded-xl bg-base-100/95 backdrop-blur-sm border border-base-300 shadow-lg text-sm text-base-content placeholder:text-base-content/40 focus:outline-none focus:ring-2 focus:ring-primary/50" data-v-004eff07${_scopeId}><svg class="absolute left-2.5 top-1/2 -translate-y-1/2 w-4 h-4 text-base-content/40" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-004eff07${_scopeId}><circle cx="11" cy="11" r="8" data-v-004eff07${_scopeId}></circle><path d="m21 21-4.35-4.35" data-v-004eff07${_scopeId}></path></svg></div><button${ssrIncludeBooleanAttr(locating.value) ? " disabled" : ""} class="h-10 w-10 rounded-xl bg-base-100/95 backdrop-blur-sm border border-base-300 shadow-lg flex items-center justify-center shrink-0 cursor-pointer hover:bg-primary/10 transition-colors disabled:opacity-50" title="ตำแหน่งของฉัน" data-v-004eff07${_scopeId}>`);
            if (locating.value) {
              _push2(`<span class="loading loading-spinner loading-xs text-primary" data-v-004eff07${_scopeId}></span>`);
            } else {
              _push2(`<svg class="w-5 h-5 text-primary" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-004eff07${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M12 2v2m0 16v2M2 12h2m16 0h2m-5.636-5.636L14.95 7.778M9.05 16.222l-1.414 1.414M7.778 9.05L6.364 7.636m11.272 8.728l1.414 1.414" data-v-004eff07${_scopeId}></path><circle cx="12" cy="12" r="4" data-v-004eff07${_scopeId}></circle></svg>`);
            }
            _push2(`</button><button class="h-10 w-10 rounded-xl bg-base-100/95 backdrop-blur-sm border border-base-300 shadow-lg flex items-center justify-center shrink-0 cursor-pointer hover:bg-primary/10 transition-colors" title="รายการสนาม" data-v-004eff07${_scopeId}><svg class="w-5 h-5 text-base-content/70" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-004eff07${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 10h16M4 14h16M4 18h16" data-v-004eff07${_scopeId}></path></svg></button></div>`);
            if (locationError.value) {
              _push2(`<div class="absolute bottom-20 left-1/2 -translate-x-1/2 z-[1000]" data-v-004eff07${_scopeId}><div class="bg-base-100/95 backdrop-blur-sm text-base-content text-xs font-medium px-4 py-2 rounded-full shadow-lg border border-base-300 flex items-center gap-2 whitespace-nowrap" data-v-004eff07${_scopeId}><span class="text-warning" data-v-004eff07${_scopeId}>⚠</span> ${ssrInterpolate(locationError.value)} <button class="text-base-content/40 hover:text-base-content cursor-pointer bg-transparent border-0 text-xs ml-1" data-v-004eff07${_scopeId}>✕</button></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (showList.value) {
              _push2(`<div class="absolute bottom-0 left-0 right-0 z-[1000] max-h-[60vh] bg-base-100/95 backdrop-blur-xl rounded-t-2xl shadow-2xl border-t border-base-300 overflow-hidden flex flex-col" data-v-004eff07${_scopeId}><div class="flex justify-center pt-2 pb-1 shrink-0" data-v-004eff07${_scopeId}><div class="w-10 h-1 rounded-full bg-base-300" data-v-004eff07${_scopeId}></div></div><div class="px-4 py-2 border-b border-base-200 flex items-center justify-between shrink-0" data-v-004eff07${_scopeId}><span class="text-sm font-bold text-base-content" data-v-004eff07${_scopeId}> สนามแบดมินตัน <span class="text-base-content/40 font-normal ml-1" data-v-004eff07${_scopeId}>(${ssrInterpolate(filteredCourts.value.length)})</span></span><button class="btn btn-ghost btn-xs btn-circle" data-v-004eff07${_scopeId}><svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-004eff07${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" data-v-004eff07${_scopeId}></path></svg></button></div><div class="overflow-y-auto flex-1 overscroll-contain" data-v-004eff07${_scopeId}>`);
              if (filteredCourts.value.length === 0) {
                _push2(`<div class="py-8 text-center text-sm text-base-content/40" data-v-004eff07${_scopeId}> ไม่พบสนาม </div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<!--[-->`);
              ssrRenderList(filteredCourts.value, (court) => {
                _push2(`<button class="w-full text-left px-4 py-3 border-b border-base-200 hover:bg-primary/5 transition-colors cursor-pointer bg-transparent border-0 border-solid" data-v-004eff07${_scopeId}><div class="flex items-start gap-3" data-v-004eff07${_scopeId}><div class="w-9 h-9 rounded-lg bg-success/10 flex items-center justify-center shrink-0 mt-0.5" data-v-004eff07${_scopeId}><svg class="w-5 h-5 text-success" viewBox="0 0 24 24" fill="currentColor" data-v-004eff07${_scopeId}><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" data-v-004eff07${_scopeId}></path></svg></div><div class="flex-1 min-w-0" data-v-004eff07${_scopeId}><div class="text-sm font-bold text-base-content truncate" data-v-004eff07${_scopeId}>${ssrInterpolate(court.name)}</div>`);
                if (court.address) {
                  _push2(`<div class="text-[11px] text-base-content/50 truncate mt-0.5" data-v-004eff07${_scopeId}>${ssrInterpolate(court.address)}</div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`<div class="flex items-center gap-2 mt-1" data-v-004eff07${_scopeId}>`);
                if (court.field_total) {
                  _push2(`<span class="text-[10px] text-base-content/40" data-v-004eff07${_scopeId}>🏸 ${ssrInterpolate(court.field_total)} สนาม</span>`);
                } else {
                  _push2(`<!---->`);
                }
                if (court.play_price) {
                  _push2(`<span class="text-[10px] text-base-content/40" data-v-004eff07${_scopeId}>💰 ${ssrInterpolate(parseFloat(court.play_price).toLocaleString())}฿</span>`);
                } else {
                  _push2(`<!---->`);
                }
                if (court.has_buffet_session) {
                  _push2(`<span class="text-[10px] text-warning font-semibold" data-v-004eff07${_scopeId}>🎾 บุฟเฟ่ต์</span>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div></div>`);
                if (court.distance != null) {
                  _push2(`<div class="text-right shrink-0" data-v-004eff07${_scopeId}><div class="text-sm font-bold text-primary" data-v-004eff07${_scopeId}>${ssrInterpolate(court.distance.toFixed(1))}</div><div class="text-[10px] text-base-content/40" data-v-004eff07${_scopeId}>กม.</div></div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div></button>`);
            ...
            if (!showList.value) {
              _push2(`<div class="absolute bottom-4 left-1/2 -translate-x-1/2 z-[1000]" data-v-004eff07${_scopeId}><button class="h-10 px-5 rounded-full bg-primary text-primary-content shadow-lg border-0 cursor-pointer text-sm font-bold hover:bg-primary/90 transition-colors flex items-center gap-2" data-v-004eff07${_scopeId}><svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-004eff07${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 10h16M4 14h16M4 18h16" data-v-004eff07${_scopeId}></path></svg> สนาม ${ssrInterpolate(filteredCourts.value.length)} แห่ง `);
              if (userLocation.value) {
                _push2(`<span class="text-primary-content/70" data-v-004eff07${_scopeId}>· ใกล้คุณ</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</button></div>`);
                ...
                createVNode(Transition, { name: "slide-up" }, {
                  default: withCtx(() => [
                    locationError.value ? (openBlock(), createBlock("div", {
                      ...
                      createVNode("div", { class: "bg-base-100/95 backdrop-blur-sm text-base-content text-xs font-medium px-4 py-2 rounded-full shadow-lg border border-base-300 flex items-center gap-2 whitespace-nowrap" }, [
                        ...
                        createVNode("button", {
                          ...
                          class: "text-base-content/40 hover:text-base-content cursor-pointer bg-transparent border-0 text-xs ml-1"
                        }, "✕", 8, ["onClick"])
                      ])
...
const CourtMap = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-004eff07"]]);
export {
  CourtMap as default
};
