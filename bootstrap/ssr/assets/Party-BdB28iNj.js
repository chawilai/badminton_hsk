...
import { _ as _sfc_main$4 } from "./AppLayout-DvUwNqCw.js";
import { _ as _sfc_main$3 } from "./UserAvatar-Dwoh2ac-.js";
import Game from "./Game2-LuBGi0yC.js";
import _sfc_main$5 from "./TabGame-DbB2BrxI.js";
import _sfc_main$6 from "./TabInfo-CSTecxEr.js";
import _sfc_main$7 from "./TabPlayer-CqMIS1ID.js";
import _sfc_main$8 from "./TabStatistic-eBG9Qerf.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$4, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(`<div class="mb-4" data-v-12fb1a2f${_scopeId}><div class="flex items-center justify-between mb-3" data-v-12fb1a2f${_scopeId}><div data-v-12fb1a2f${_scopeId}><div class="text-base font-bold text-base-content m-0 leading-tight" data-v-12fb1a2f${_scopeId}>${ssrInterpolate(party.value.name || ((_a = party.value.court) == null ? void 0 : _a.name) || "Party")} <span class="text-xs font-normal text-base-content/50" data-v-12fb1a2f${_scopeId}>#${ssrInterpolate(party.value.id)}</span></div>`);
            if (party.value.name && ((_b = party.value.court) == null ? void 0 : _b.name)) {
              _push2(`<p class="text-[10px] text-base-content/40 m-0" data-v-12fb1a2f${_scopeId}>🏟️ ${ssrInterpolate(party.value.court.name)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<p class="text-xs text-base-content/60 m-0 mt-0.5" data-v-12fb1a2f${_scopeId}>${ssrInterpolate(party.value.play_date)} · ${ssrInterpolate((_c = party.value.start_time) == null ? void 0 : _c.substring(0, 5))} - ${ssrInterpolate((_d = party.value.end_time) == null ? void 0 : _d.substring(0, 5))}</p></div><div class="flex items-center gap-2" data-v-12fb1a2f${_scopeId}>`);
            if (party.value.creator_id === ((_e = unref(page).props.auth.user) == null ? void 0 : _e.id)) {
              _push2(`<button class="w-9 h-9 flex items-center justify-center rounded-lg border border-base-300 bg-base-100 text-base-content/60 hover:bg-base-200 transition-colors cursor-pointer" title="ลิงก์เชิญ" data-v-12fb1a2f${_scopeId}><span class="text-sm" data-v-12fb1a2f${_scopeId}>🔗</span></button>`);
            } else {
              _push2(`<!---->`);
            }
            if (party.value.status !== "Over") {
              _push2(`<a${ssrRenderAttr("href", `/party/${party.value.id}/tv`)} target="_blank" class="w-9 h-9 flex items-center justify-center rounded-lg border border-base-300 bg-base-100 text-base-content/60 hover:bg-base-200 transition-colors cursor-pointer" title="TV Dashboard" data-v-12fb1a2f${_scopeId}><span class="text-sm" data-v-12fb1a2f${_scopeId}>📺</span></a>`);
            } else {
              _push2(`<!---->`);
            }
            if (party.value.status === "Over") {
              _push2(`<button class="w-9 h-9 flex items-center justify-center rounded-lg border border-base-300 bg-base-100 text-base-content/60 hover:bg-base-200 transition-colors cursor-pointer" title="ตั้งตี้ใหม่" data-v-12fb1a2f${_scopeId}><span class="text-sm" data-v-12fb1a2f${_scopeId}>🔄</span></button>`);
            } else {
              _push2(`<!---->`);
            }
            if (party.value.status !== "Over") {
              _push2(`<button class="h-8 px-3 flex items-center gap-1 rounded-lg bg-error/10 hover:bg-error/20 text-error text-xs font-medium border-0 cursor-pointer transition-colors active:scale-[0.98] whitespace-nowrap shrink-0" data-v-12fb1a2f${_scopeId}><span data-v-12fb1a2f${_scopeId}>🏁</span><span data-v-12fb1a2f${_scopeId}>จบปาร์ตี้</span></button>`);
            } else {
              _push2(`<!---->`);
            }
            if (party.value.status === "Over") {
              _push2(`<button class="h-8 px-3 flex items-center gap-1 rounded-lg bg-info/10 hover:bg-info/20 text-info text-xs font-medium border-0 cursor-pointer transition-colors active:scale-[0.98] whitespace-nowrap shrink-0" data-v-12fb1a2f${_scopeId}><span data-v-12fb1a2f${_scopeId}>💰</span><span data-v-12fb1a2f${_scopeId}>สรุปค่าใช้จ่าย</span></button>`);
            } else {
              _push2(`<!---->`);
            }
            if (party.value.status !== "Over") {
              _push2(`<button class="h-8 px-3 flex items-center gap-1 rounded-lg bg-primary hover:bg-primary/80 text-white text-xs font-medium border-0 cursor-pointer transition-colors active:scale-[0.98] whitespace-nowrap shrink-0" data-v-12fb1a2f${_scopeId}><span data-v-12fb1a2f${_scopeId}>+</span><span data-v-12fb1a2f${_scopeId}>${ssrInterpolate(unref(t)("party.newGame"))}</span></button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div><div class="${ssrRenderClass([{ "drawer-open-custom": visibleTop.value }, "drawer drawer-end"])}" data-v-12fb1a2f${_scopeId}>`);
            if (visibleTop.value) {
              _push2(`<div class="fixed inset-0 bg-black/50 z-40" data-v-12fb1a2f${_scopeId}></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="${ssrRenderClass([visibleTop.value ? "translate-y-0" : "-translate-y-full", "fixed top-0 left-0 right-0 z-50 bg-base-100 shadow-lg transition-transform duration-300"])}" style="${ssrRenderStyle({ "max-height": "90vh" })}" data-v-12fb1a2f${_scopeId}><div class="flex items-center gap-2 p-3 border-b border-base-300" data-v-12fb1a2f${_scopeId}>`);
            ...
            _push2(`<span class="font-bold" data-v-12fb1a2f${_scopeId}>${ssrInterpolate(unref(t)("party.gameMaking"))}</span><button class="btn btn-sm btn-ghost ml-auto" data-v-12fb1a2f${_scopeId}>✕</button></div><div class="overflow-y-auto" style="${ssrRenderStyle({ "max-height": "calc(90vh - 3.5rem)" })}" data-v-12fb1a2f${_scopeId}><div class="p-3" data-v-12fb1a2f${_scopeId}>`);
            _push2(ssrRenderComponent(Game, {
              data: _ctx.$page.props,
              onGameCreated: partyReload
            }, null, _parent2, _scopeId));
            _push2(`</div></div></div></div><dialog class="${ssrRenderClass([{ "modal-open": visible.value }, "modal"])}" data-v-12fb1a2f${_scopeId}><div class="modal-box w-[95vw] max-w-[28rem] p-0" data-v-12fb1a2f${_scopeId}><div class="flex items-center justify-between px-4 pt-4 pb-2" data-v-12fb1a2f${_scopeId}><div class="flex items-center gap-2" data-v-12fb1a2f${_scopeId}><div class="w-8 h-8 bg-primary/10 rounded-lg flex items-center justify-center" data-v-12fb1a2f${_scopeId}><span class="text-base" data-v-12fb1a2f${_scopeId}>🏸</span></div><h2 class="text-base font-bold text-base-content m-0" data-v-12fb1a2f${_scopeId}>บันทึกผลการแข่งขัน</h2></div><button class="w-8 h-8 rounded-lg bg-base-200 hover:bg-base-300 border-0 cursor-pointer flex items-center justify-center transition-colors" data-v-12fb1a2f${_scopeId}><span class="text-base-content/60 text-sm" data-v-12fb1a2f${_scopeId}>✕</span></button></div><div class="px-4 pb-2" data-v-12fb1a2f${_scopeId}><div class="flex items-center justify-center gap-3 mb-3 py-2" data-v-12fb1a2f${_scopeId}><span class="text-sm font-bold text-base-content/60" data-v-12fb1a2f${_scopeId}>Team 1</span><div class="flex items-center gap-1" data-v-12fb1a2f${_scopeId}><span class="${ssrRenderClass([setWins.value.t1 > setWins.value.t2 ? "text-warning" : "text-base-content/40", "text-2xl font-black"])}" data-v-12fb1a2f${_scopeId}>${ssrInterpolate(setWins.value.t1)}</span><span class="text-lg text-base-content/30 font-bold" data-v-12fb1a2f${_scopeId}>:</span><span class="${ssrRenderClass([setWins.value.t2 > setWins.value.t1 ? "text-warning" : "text-base-content/40", "text-2xl font-black"])}" data-v-12fb1a2f${_scopeId}>${ssrInterpolate(setWins.value.t2)}</span></div><span class="text-sm font-bold text-base-content/60" data-v-12fb1a2f${_scopeId}>Team 2</span></div><!--[-->`);
            ssrRenderList(sets.value, (set, index) => {
              var _a2, _b2;
              _push2(`<div class="mb-4" data-v-12fb1a2f${_scopeId}><div class="flex items-center justify-center mb-3" data-v-12fb1a2f${_scopeId}><span class="px-3 py-1 bg-primary/10 text-primary text-xs font-bold rounded-full uppercase tracking-wider" data-v-12fb1a2f${_scopeId}> Set ${ssrInterpolate(index + 1)}</span></div><div class="grid grid-cols-2 gap-2" data-v-12fb1a2f${_scopeId}><div class="${ssrRenderClass([showCrown(index, "team1") ? "bg-warning/10 border border-warning/30" : "bg-base-200 border border-base-300", "rounded-xl p-3 text-center relative transition-colors"])}" data-v-12fb1a2f${_scopeId}><img style="${ssrRenderStyle(showCrown(index, "team1") ? null : { display: "none" })}"${ssrRenderAttr("src", unref(crown))} class="w-8 h-8 absolute -top-3 -left-1 -rotate-[25deg]" alt="" data-v-12fb1a2f${_scopeId}><p class="text-[10px] text-base-content/50 font-bold uppercase tracking-wider m-0 mb-2" data-v-12fb1a2f${_scopeId}>Team 1</p><div class="flex justify-center gap-1.5 mb-3" data-v-12fb1a2f${_scopeId}><!--[-->`);
              ssrRenderList((_a2 = setScoreGame.value.game_players) == null ? void 0 : _a2.filter((p) => p.team === "team1" || p.team === 1), (player) => {
                var _a3, _b3, _c2;
                _push2(`<div class="text-center" data-v-12fb1a2f${_scopeId}>`);
                _push2(ssrRenderComponent(_sfc_main$3, {
                ...
                _push2(`<p class="text-[9px] text-base-content/60 m-0 mt-0.5 truncate max-w-[3.5rem]" data-v-12fb1a2f${_scopeId}>${ssrInterpolate(player.display_name || ((_c2 = player.user) == null ? void 0 : _c2.name))}</p></div>`);
              });
              _push2(`<!--]--></div><div class="flex items-center justify-center gap-2 mb-2" data-v-12fb1a2f${_scopeId}><button type="button" class="w-9 h-9 rounded-lg bg-error/10 text-error border-0 cursor-pointer font-bold text-lg hover:bg-error/20 transition-colors" data-v-12fb1a2f${_scopeId}>-</button><div class="${ssrRenderClass([showCrown(index, "team1") ? "text-warning" : "text-base-content/80", "text-3xl font-black min-w-[2.5rem]"])}" data-v-12fb1a2f${_scopeId}>${ssrInterpolate(set.team1_score)}</div><button type="button" class="w-9 h-9 rounded-lg bg-primary/10 text-primary border-0 cursor-pointer font-bold text-lg hover:bg-primary/20 transition-colors" data-v-12fb1a2f${_scopeId}>+</button></div><div class="flex justify-center gap-1.5 mb-2" data-v-12fb1a2f${_scopeId}><button type="button" class="px-2.5 py-1 rounded-lg text-[10px] font-semibold bg-base-300 text-base-content/70 border-0 cursor-pointer hover:bg-base-300/80 transition-colors" data-v-12fb1a2f${_scopeId}>รีเซ็ต</button><button type="button" class="px-2.5 py-1 rounded-lg text-[10px] font-semibold bg-base-300 text-base-content/70 border-0 cursor-pointer hover:bg-base-300/80 transition-colors" data-v-12fb1a2f${_scopeId}>21 แต้ม</button></div><div class="px-1" data-v-12fb1a2f${_scopeId}><input type="range"${ssrRenderAttr("min", 0)}${ssrRenderAttr("max", 30)}${ssrRenderAttr("value", set.team1_score)} class="range range-primary range-sm w-full" data-v-12fb1a2f${_scopeId}></div></div><div class="${ssrRenderClass([showCrown(index, "team2") ? "bg-warning/10 border border-warning/30" : "bg-base-200 border border-base-300", "rounded-xl p-3 text-center relative transition-colors"])}" data-v-12fb1a2f${_scopeId}><img style="${ssrRenderStyle(showCrown(index, "team2") ? null : { display: "none" })}"${ssrRenderAttr("src", unref(crown))} class="w-8 h-8 absolute -top-3 -right-1 rotate-[25deg]" alt="" data-v-12fb1a2f${_scopeId}><p class="text-[10px] text-base-content/50 font-bold uppercase tracking-wider m-0 mb-2" data-v-12fb1a2f${_scopeId}>Team 2</p><div class="flex justify-center gap-1.5 mb-3" data-v-12fb1a2f${_scopeId}><!--[-->`);
              ...
              _push2(`<!--]--></div><div class="flex items-center justify-center gap-2 mb-2" data-v-12fb1a2f${_scopeId}><button type="button" class="w-9 h-9 rounded-lg bg-error/10 text-error border-0 cursor-pointer font-bold text-lg hover:bg-error/20 transition-colors" data-v-12fb1a2f${_scopeId}>-</button><div class="${ssrRenderClass([showCrown(index, "team2") ? "text-warning" : "text-base-content/80", "text-3xl font-black min-w-[2.5rem]"])}" data-v-12fb1a2f${_scopeId}>${ssrInterpolate(set.team2_score)}</div><button type="button" class="w-9 h-9 rounded-lg bg-primary/10 text-primary border-0 cursor-pointer font-bold text-lg hover:bg-primary/20 transition-colors" data-v-12fb1a2f${_scopeId}>+</button></div><div class="flex justify-center gap-1.5 mb-2" data-v-12fb1a2f${_scopeId}><button type="button" class="px-2.5 py-1 rounded-lg text-[10px] font-semibold bg-base-300 text-base-content/70 border-0 cursor-pointer hover:bg-base-300/80 transition-colors" data-v-12fb1a2f${_scopeId}>รีเซ็ต</button><button type="button" class="px-2.5 py-1 rounded-lg text-[10px] font-semibold bg-base-300 text-base-content/70 border-0 cursor-pointer hover:bg-base-300/80 transition-colors" data-v-12fb1a2f${_scopeId}>21 แต้ม</button></div><div class="px-1" data-v-12fb1a2f${_scopeId}><input type="range"${ssrRenderAttr("min", 0)}${ssrRenderAttr("max", 30)}${ssrRenderAttr("value", set.team2_score)} class="range range-primary range-sm w-full" data-v-12fb1a2f${_scopeId}></div></div></div>`);
              if (index < sets.value.length - 1) {
                _push2(`<div class="flex items-center gap-3 my-3" data-v-12fb1a2f${_scopeId}><div class="flex-1 h-px bg-base-300" data-v-12fb1a2f${_scopeId}></div><div class="flex-1 h-px bg-base-300" data-v-12fb1a2f${_scopeId}></div></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            });
            _push2(`<!--]--></div><div class="flex items-center justify-center gap-2 px-4 pb-3" data-v-12fb1a2f${_scopeId}><button type="button" class="h-8 px-4 rounded-lg text-xs font-semibold bg-primary/5 text-primary border border-primary/20 cursor-pointer hover:bg-primary/10 transition-colors" data-v-12fb1a2f${_scopeId}> + เพิ่ม Set ${ssrInterpolate(sets.value.length + 1)}</button><button style="${ssrRenderStyle(sets.value.length > 1 ? null : { display: "none" })}" type="button" class="h-8 px-4 rounded-lg text-xs font-semibold bg-error/10 text-error border border-error/20 cursor-pointer hover:bg-error/20 transition-colors" data-v-12fb1a2f${_scopeId}> - ลบ Set </button></div><div class="flex gap-2 px-4 pb-4" data-v-12fb1a2f${_scopeId}><button type="button" class="flex-1 h-10 rounded-xl text-sm font-medium bg-base-200 text-base-content/80 border-0 cursor-pointer hover:bg-base-300 transition-colors" data-v-12fb1a2f${_scopeId}>${ssrInterpolate(unref(t)("common.cancel"))}</button><button type="button" class="flex-1 h-10 rounded-xl text-sm font-semibold bg-primary text-white border-0 cursor-pointer hover:bg-primary/80 transition-colors active:scale-[0.98]" data-v-12fb1a2f${_scopeId}> ✓ ${ssrInterpolate(unref(t)("common.save"))}</button></div></div><form method="dialog" class="modal-backdrop" data-v-12fb1a2f${_scopeId}><button data-v-12fb1a2f${_scopeId}>close</button></form></dialog><div class="flex gap-1 p-1 bg-base-200 rounded-xl mb-4" data-v-12fb1a2f${_scopeId}><!--[-->`);
            ssrRenderList(tabs.value, (tab) => {
              _push2(`<button class="${ssrRenderClass([activeTab.value === tab.key ? "bg-primary text-primary-content shadow-sm" : "bg-transparent text-base-content/50 hover:text-base-content hover:bg-base-300/50", "flex-1 flex items-center justify-center gap-1.5 py-2.5 px-3 rounded-lg text-sm font-semibold transition-all duration-200 cursor-pointer border-0"])}" data-v-12fb1a2f${_scopeId}><span data-v-12fb1a2f${_scopeId}>${ssrInterpolate(tab.icon)}</span><span data-v-12fb1a2f${_scopeId}>${ssrInterpolate(tab.label)}</span>`);
              if (tab.count != null) {
                _push2(`<span class="text-[10px] opacity-70" data-v-12fb1a2f${_scopeId}>(${ssrInterpolate(tab.count)})</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</button>`);
            });
            _push2(`<!--]--></div><div style="${ssrRenderStyle(activeTab.value === "game" ? null : { display: "none" })}" data-v-12fb1a2f${_scopeId}>`);
            ...
            _push2(`</div><div style="${ssrRenderStyle(activeTab.value === "info" ? null : { display: "none" })}" data-v-12fb1a2f${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$6, {
              party: party.value,
              costSummary: unref(costSummary)
            }, null, _parent2, _scopeId));
            _push2(`</div><div style="${ssrRenderStyle(activeTab.value === "player" ? null : { display: "none" })}" data-v-12fb1a2f${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$7, {
              party: party.value,
              friendshipMap: unref(page).props.friendshipMap || {},
              onUpdateDisplayName: updateDisplayName
            }, null, _parent2, _scopeId));
            _push2(`</div><div style="${ssrRenderStyle(activeTab.value === "stats" ? null : { display: "none" })}" data-v-12fb1a2f${_scopeId}>`);
...
const Party = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-12fb1a2f"]]);
export {
  Party as default
};
