          ...
          if (_push2) {
            ...
            if (!selectedChatId.value) {
              ...
              ssrRenderList(messages.value, (msg, index) => {
                ...
                _push2(`<div class="${ssrRenderClass([isMyMessage(msg) ? "bg-primary text-white rounded-2xl rounded-br-md" : "bg-base-100 text-base-content border border-base-300 rounded-2xl rounded-bl-md", "px-3 py-2 text-sm leading-relaxed"])}"${_scopeId}>${ssrInterpolate(msg.content)}</div><p class="${ssrRenderClass([isMyMessage(msg) ? "justify-end mr-1" : "ml-1", "text-[10px] text-base-content/40 m-0 mt-0.5 flex items-center gap-1"])}"${_scopeId}><span${_scopeId}>${ssrInterpolate(formatTime(msg.created_at))}</span>`);
                if (isMyMessage(msg)) {
                  _push2(`<!--[-->`);
                  if (isReadByOther(msg)) {
                    _push2(`<svg class="w-4 h-4 text-info" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M1 12l5 5L17 6M7 12l5 5L23 6"${_scopeId}></path></svg>`);
                  } else {
                    _push2(`<svg class="w-3.5 h-3.5 text-base-content/30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M5 12l5 5L20 7"${_scopeId}></path></svg>`);
                  }
                  _push2(`<!--]-->`);
                } else {
                  _push2(`<!---->`);
                      ...
                      (openBlock(true), createBlock(Fragment, null, renderList(messages.value, (msg, index) => {
                        ...
                        return openBlock(), createBlock("div", {
                          ...
                          createVNode("div", { class: "max-w-[75%]" }, [
                            ...
                            createVNode("p", {
                              class: ["text-[10px] text-base-content/40 m-0 mt-0.5 flex items-center gap-1", isMyMessage(msg) ? "justify-end mr-1" : "ml-1"]
                            }, [
                              createVNode("span", null, toDisplayString(formatTime(msg.created_at)), 1),
                              isMyMessage(msg) ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                                isReadByOther(msg) ? (openBlock(), createBlock("svg", {
                                  key: 0,
                                  ...
                                  createVNode("path", {
                                    "stroke-linecap": "round",
                                    "stroke-linejoin": "round",
                                    d: "M1 12l5 5L17 6M7 12l5 5L23 6"
                                  })
                                ])) : (openBlock(), createBlock("svg", {
                                  key: 1,
