...
import { _ as _sfc_main$7 } from "./LocaleSwitcher-BOmG4hBt.js";
import { _ as _sfc_main$8 } from "./UserAvatar-Dwoh2ac-.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-2xl"${_scopeId}>🏸</span><span class="font-bold text-lg text-primary hidden sm:inline"${_scopeId}> Badminton Party </span>`);
          } else {
            return [
...
const DaisyToast = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-9fe57950"]]);
const _sfc_main$2 = {
