import { computed, ref, watch, unref, withCtx, createVNode, withModifiers, withDirectives, createBlock, createCommentVNode, vModelText, openBlock, toDisplayString, Fragment, renderList, createTextVNode, useSSRContext } from "vue";
  ...
  setup(__props) {
    ...
    const saveProfile = () => {
      form.patch(route("profile.update"), {
        onSuccess: () => toast.add({ severity: "success", summary: "บันทึกโปรไฟล์เรียบร้อย", life: 3e3 })
      });
    };
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<h1 class="text-lg font-bold text-base-content m-0"${_scopeId}>แก้ไขโปรไฟล์</h1><p class="text-xs text-base-content/50 mt-1 m-0"${_scopeId}>จัดการข้อมูลส่วนตัวและการยืนยันตัวตน</p></div><form class="bg-base-100 rounded-2xl border border-base-300 overflow-hidden"${_scopeId}><div class="px-4 py-3 border-b border-base-200"${_scopeId}><h2 class="text-sm font-bold text-base-content m-0"${_scopeId}>ข้อมูลส่วนตัว</h2></div><div class="p-4 space-y-4"${_scopeId}><div${_scopeId}><label class="text-xs font-semibold text-base-content/70 mb-1 block"${_scopeId}>ชื่อที่แสดง</label><input${ssrRenderAttr("value", unref(form).name)} type="text" required class="input input-bordered w-full" placeholder="ชื่อของคุณ"${_scopeId}>`);
            if (unref(form).errors.name) {
              _push2(`<p class="text-xs text-error mt-1"${_scopeId}>${ssrInterpolate(unref(form).errors.name)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div${_scopeId}><label class="text-xs font-semibold text-base-content/70 mb-1 block"${_scopeId}>เพศ</label><div class="flex gap-2"${_scopeId}><!--[-->`);
            ssrRenderList([{ key: "male", label: "ชาย", icon: "👨" }, { key: "female", label: "หญิง", icon: "👩" }, { key: "other", label: "อื่นๆ", icon: "🧑" }], (g) => {
              _push2(`<button type="button" class="${ssrRenderClass([unref(form).gender === g.key ? "bg-primary/10 border-primary text-primary" : "bg-base-100 border-base-300 text-base-content/60 hover:border-primary/50", "flex-1 py-2.5 rounded-xl border cursor-pointer text-center transition-all text-sm font-semibold"])}"${_scopeId}>${ssrInterpolate(g.icon)} ${ssrInterpolate(g.label)}</button>`);
            });
            _push2(`<!--]--></div>`);
            if (unref(form).errors.gender) {
              _push2(`<p class="text-xs text-error mt-1"${_scopeId}>${ssrInterpolate(unref(form).errors.gender)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div${_scopeId}><label class="text-xs font-semibold text-base-content/70 mb-1 block"${_scopeId}>วันเกิด</label><input${ssrRenderAttr("value", unref(form).date_of_birth)} type="date" class="input input-bordered w-full"${_scopeId}>`);
            if (unref(form).errors.date_of_birth) {
              _push2(`<p class="text-xs text-error mt-1"${_scopeId}>${ssrInterpolate(unref(form).errors.date_of_birth)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div${_scopeId}><label class="text-xs font-semibold text-base-content/70 mb-1 block"${_scopeId}>ที่อยู่ (ตำบล/อำเภอ/จังหวัด)</label><p class="text-[10px] text-base-content/40 mb-1.5"${_scopeId}>ใช้ประเมินความหนาแน่นของนักแบดมินตันในพื้นที่</p><div class="relative"${_scopeId}><input${ssrRenderAttr("value", addressQuery.value)} type="text" class="input input-bordered w-full" placeholder="พิมพ์ชื่อตำบล อำเภอ หรือจังหวัด..."${_scopeId}>`);
            if (showAddressDropdown.value) {
              _push2(`<div class="absolute z-50 w-full mt-1 bg-base-100 border border-base-300 rounded-xl shadow-lg max-h-48 overflow-y-auto"${_scopeId}><!--[-->`);
              ssrRenderList(addressResults.value, (addr, i) => {
                _push2(`<button type="button" class="w-full text-left px-3 py-2.5 text-sm hover:bg-primary/10 cursor-pointer border-0 bg-transparent transition-colors"${_scopeId}><span class="font-semibold text-base-content"${_scopeId}>${ssrInterpolate(addr.district)}</span><span class="text-base-content/50"${_scopeId}> &gt; ${ssrInterpolate(addr.amphoe)} &gt; ${ssrInterpolate(addr.province)}</span><span class="text-base-content/30 text-xs ml-1"${_scopeId}>${ssrInterpolate(addr.zipcode)}</span></button>`);
              });
              _push2(`<!--]--></div>`);
            } else {
              _push2(`<!---->`);
            ...
            if (unref(form).subdistrict) {
              _push2(`<div class="mt-1.5 flex items-center gap-1.5"${_scopeId}><span class="badge badge-primary badge-sm gap-1"${_scopeId}><svg class="w-3 h-3" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"${_scopeId}></path><path stroke-linecap="round" stroke-linejoin="round" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"${_scopeId}></path></svg> ${ssrInterpolate(unref(form).subdistrict)}, ${ssrInterpolate(unref(form).district)}, ${ssrInterpolate(unref(form).province)}</span></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><button type="submit"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} class="w-full py-3 rounded-xl text-sm font-bold bg-primary text-primary-content border-0 cursor-pointer hover:bg-primary/80 transition-all active:scale-[0.98] disabled:opacity-50"${_scopeId}>`);
            if (unref(form).processing) {
              _push2(`<span class="loading loading-spinner loading-xs mr-1"${_scopeId}></span>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(` บันทึกข้อมูล </button></div></form><div class="bg-base-100 rounded-2xl border border-base-300 overflow-hidden"${_scopeId}><div class="px-4 py-3 border-b border-base-200 flex items-center justify-between"${_scopeId}><h2 class="text-sm font-bold text-base-content m-0"${_scopeId}>เบอร์โทรศัพท์</h2>`);
            if (phoneVerified.value) {
              _push2(`<span class="badge badge-success badge-sm gap-1"${_scopeId}><svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20"${_scopeId}><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"${_scopeId}></path></svg> ยืนยันแล้ว </span>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="p-4 space-y-3"${_scopeId}>`);
            if (phoneStep.value === "verified") {
              _push2(`<div class="flex items-center gap-3"${_scopeId}><div class="flex-1"${_scopeId}><div class="text-sm font-semibold text-base-content"${_scopeId}>${ssrInterpolate(phoneNumber.value)}</div><div class="text-[10px] text-success"${_scopeId}>ยืนยันแล้ว</div></div><button type="button" class="text-xs text-primary font-semibold border-0 bg-transparent cursor-pointer hover:underline"${_scopeId}>เปลี่ยน</button></div>`);
            } else if (phoneStep.value === "input") {
              _push2(`<div${_scopeId}><label class="text-xs font-semibold text-base-content/70 mb-1 block"${_scopeId}>เบอร์โทร</label><div class="flex gap-2"${_scopeId}><input${ssrRenderAttr("value", phoneNumber.value)} type="tel" placeholder="08x-xxx-xxxx" maxlength="10" class="input input-bordered flex-1"${_scopeId}><button${ssrIncludeBooleanAttr(phoneSending.value || !phoneNumber.value || phoneNumber.value.length < 9) ? " disabled" : ""} class="btn btn-primary btn-sm px-4" type="button"${_scopeId}>`);
              if (phoneSending.value) {
                _push2(`<span class="loading loading-spinner loading-xs"${_scopeId}></span>`);
              } else {
                _push2(`<span${_scopeId}>ส่ง OTP</span>`);
              }
              _push2(`</button></div></div>`);
            } else if (phoneStep.value === "otp") {
              _push2(`<!--[--><p class="text-xs text-base-content/60 m-0"${_scopeId}>ส่งรหัส OTP ไปที่ <strong${_scopeId}>${ssrInterpolate(phoneNumber.value)}</strong></p><div class="flex gap-2"${_scopeId}><input${ssrRenderAttr("value", phoneOtp.value)} type="text" placeholder="กรอกรหัส 6 หลัก" maxlength="6" class="input input-bordered flex-1 text-center text-lg tracking-[8px] font-mono"${_scopeId}><button${ssrIncludeBooleanAttr(phoneVerifying.value || phoneOtp.value.length !== 6) ? " disabled" : ""} class="btn btn-primary btn-sm px-4" type="button"${_scopeId}>`);
              if (phoneVerifying.value) {
                _push2(`<span class="loading loading-spinner loading-xs"${_scopeId}></span>`);
              } else {
                _push2(`<span${_scopeId}>ยืนยัน</span>`);
              }
              _push2(`</button></div><div class="flex items-center justify-between"${_scopeId}><button type="button" class="text-xs text-base-content/50 border-0 bg-transparent cursor-pointer hover:text-primary"${_scopeId}>เปลี่ยนเบอร์</button><button${ssrIncludeBooleanAttr(phoneCooldown.value > 0 || phoneSending.value) ? " disabled" : ""} type="button" class="text-xs text-primary font-semibold border-0 bg-transparent cursor-pointer hover:underline disabled:text-base-content/30 disabled:no-underline"${_scopeId}>${ssrInterpolate(phoneCooldown.value > 0 ? `ส่งใหม่ใน ${phoneCooldown.value}s` : "ส่งรหัสอีกครั้ง")}</button></div><!--]-->`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div class="bg-base-100 rounded-2xl border border-base-300 overflow-hidden"${_scopeId}><div class="px-4 py-3 border-b border-base-200 flex items-center justify-between"${_scopeId}><h2 class="text-sm font-bold text-base-content m-0"${_scopeId}>อีเมล</h2>`);
            ...
            if (emailStep.value === "verified") {
              _push2(`<div class="flex items-center gap-3"${_scopeId}><div class="flex-1"${_scopeId}><div class="text-sm font-semibold text-base-content"${_scopeId}>${ssrInterpolate(emailAddress.value)}</div><div class="text-[10px] text-success"${_scopeId}>ยืนยันแล้ว</div></div><button type="button" class="text-xs text-primary font-semibold border-0 bg-transparent cursor-pointer hover:underline"${_scopeId}>เปลี่ยน</button></div>`);
            } else if (emailStep.value === "input") {
              _push2(`<div${_scopeId}><label class="text-xs font-semibold text-base-content/70 mb-1 block"${_scopeId}>อีเมล</label><div class="flex gap-2"${_scopeId}><input${ssrRenderAttr("value", emailAddress.value)} type="email" placeholder="you@example.com" class="input input-bordered flex-1"${_scopeId}><button${ssrIncludeBooleanAttr(emailSending.value || !emailAddress.value) ? " disabled" : ""} class="btn btn-primary btn-sm px-4" type="button"${_scopeId}>`);
              if (emailSending.value) {
                _push2(`<span class="loading loading-spinner loading-xs"${_scopeId}></span>`);
              } else {
                _push2(`<span${_scopeId}>ส่งรหัส</span>`);
              }
              _push2(`</button></div></div>`);
            } else if (emailStep.value === "code") {
              _push2(`<!--[--><p class="text-xs text-base-content/60 m-0"${_scopeId}>ส่งรหัสยืนยันไปที่ <strong${_scopeId}>${ssrInterpolate(emailAddress.value)}</strong></p><div class="flex gap-2"${_scopeId}><input${ssrRenderAttr("value", emailCode.value)} type="text" placeholder="กรอกรหัส 6 หลัก" maxlength="6" class="input input-bordered flex-1 text-center text-lg tracking-[8px] font-mono"${_scopeId}><button${ssrIncludeBooleanAttr(emailVerifying.value || emailCode.value.length !== 6) ? " disabled" : ""} class="btn btn-primary btn-sm px-4" type="button"${_scopeId}>`);
              if (emailVerifying.value) {
                _push2(`<span class="loading loading-spinner loading-xs"${_scopeId}></span>`);
              } else {
                _push2(`<span${_scopeId}>ยืนยัน</span>`);
              }
              _push2(`</button></div><div class="flex items-center justify-between"${_scopeId}><button type="button" class="text-xs text-base-content/50 border-0 bg-transparent cursor-pointer hover:text-primary"${_scopeId}>เปลี่ยนอีเมล</button><button${ssrIncludeBooleanAttr(emailCooldown.value > 0 || emailSending.value) ? " disabled" : ""} type="button" class="text-xs text-primary font-semibold border-0 bg-transparent cursor-pointer hover:underline disabled:text-base-content/30 disabled:no-underline"${_scopeId}>${ssrInterpolate(emailCooldown.value > 0 ? `ส่งใหม่ใน ${emailCooldown.value}s` : "ส่งรหัสอีกครั้ง")}</button></div><!--]-->`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div></div>`);
                      ...
                      createVNode("div", { class: "flex gap-2" }, [
                        (openBlock(), createBlock(Fragment, null, renderList([{ key: "male", label: "ชาย", icon: "👨" }, { key: "female", label: "หญิง", icon: "👩" }, { key: "other", label: "อื่นๆ", icon: "🧑" }], (g) => {
                          return createVNode("button", {
                            type: "button",
                            key: g.key,
                            onClick: ($event) => unref(form).gender = g.key,
                            class: ["flex-1 py-2.5 rounded-xl border cursor-pointer text-center transition-all text-sm font-semibold", unref(form).gender === g.key ? "bg-primary/10 border-primary text-primary" : "bg-base-100 border-base-300 text-base-content/60 hover:border-primary/50"]
                    ...
                    createVNode("div", null, [
                      ...
                      createVNode("div", { class: "relative" }, [
                        withDirectives(createVNode("input", {
                          ...
                          onFocus: ($event) => showAddressDropdown.value = addressResults.value.length > 0,
                  ...
                  createVNode("div", { class: "p-4 space-y-3" }, [
                    phoneStep.value === "verified" ? (openBlock(), createBlock("div", {
                      ...
                      createVNode("button", {
                        onClick: changePhone,
                        type: "button",
                        class: "text-xs text-primary font-semibold border-0 bg-transparent cursor-pointer hover:underline"
                      }, "เปลี่ยน")
                      ...
                      createVNode("div", { class: "flex gap-2" }, [
                        withDirectives(createVNode("input", {
                          ...
                          maxlength: "6",
                          class: "input input-bordered flex-1 text-center text-lg tracking-[8px] font-mono"
                        }, null, 8, ["onUpdate:modelValue"]), [
                      ...
                      createVNode("div", { class: "flex items-center justify-between" }, [
                        createVNode("button", {
                          ...
                          type: "button",
                          class: "text-xs text-base-content/50 border-0 bg-transparent cursor-pointer hover:text-primary"
                        ...
                        }, toDisplayString(phoneCooldown.value > 0 ? `ส่งใหม่ใน ${phoneCooldown.value}s` : "ส่งรหัสอีกครั้ง"), 9, ["disabled"])
                      ])
                    ...
                    emailStep.value === "verified" ? (openBlock(), createBlock("div", {
                      ...
                      createVNode("div", { class: "flex items-center justify-between" }, [
                        ...
                        createVNode("button", {
                          ...
                          type: "button",
                          class: "text-xs text-primary font-semibold border-0 bg-transparent cursor-pointer hover:underline disabled:text-base-content/30 disabled:no-underline"
                        }, toDisplayString(emailCooldown.value > 0 ? `ส่งใหม่ใน ${emailCooldown.value}s` : "ส่งรหัสอีกครั้ง"), 9, ["disabled"])
                      ])
                    ], 64)) : createCommentVNode("", true)
                  ])
                ])
